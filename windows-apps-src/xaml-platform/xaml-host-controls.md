...
> [!NOTE]
> Contrôles encapsulés ne sont pas disponibles pour les applications de bureau C++ Win32. Ces types d’applications doivent utiliser l' [API d’hébergement de XAML UWP](#uwp-xaml-hosting-api).
