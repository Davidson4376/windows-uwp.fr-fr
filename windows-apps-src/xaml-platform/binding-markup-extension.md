...
| [**Source**](https://msdn.microsoft.com/library/windows/apps/br209832) | Spécifie la source de données de l’objet. Au sein de l’extension de balisage **Binding**, la [Présentation détaillée de la liaison de données ](https://msdn.microsoft.com/library/windows/apps/mt210946). |
