...
**Remarque**  pour des informations générales sur l’utilisation de la liaison de données dans votre application avec **{Binding}** (et pour une comparaison global entre **{x : Bind}** et **{Binding}**), consultez [liaison de données en profondeur](https://msdn.microsoft.com/library/windows/apps/mt210946).
...
| *bindingProperties* | *propName*=*valeur*\[, *propName*=*valeur*\]*<br/>Une ou plusieurs propriétés de liaison spécifiées à l’aide d’une syntaxe constituée d’une ou plusieurs paires nom/valeur. |
...
|----------|-------------|
| [**Chemin d’accès**](https://msdn.microsoft.com/library/windows/apps/br209830) | Voir la section [Chemin de propriété](#property-path) ci-dessus. |
