...
-   Inscrivez le nom de la propriété auprès du système de propriétés (appelez [**Register**](https://msdn.microsoft.com/library/windows/apps/hh701829)), en spécifiant un type de propriétaire et le type de la valeur de propriété. Il existe un paramètre obligatoire pour [**Register**](https://msdn.microsoft.com/library/windows/apps/hh701829) qui attend des métadonnées de propriétés. Spécifiez la valeur **null** pour ce paramètre ou spécifiez les métadonnées de propriété si vous en avez déclarées.
-   Définissez un identificateur [**DependencyProperty**](https://msdn.microsoft.com/library/windows/apps/br242362) en tant que membre de propriété **public**
          **static**
          **readonly** sur le type de propriétaire.
...
**Remarque** N’effectuez pas une inscription avec la valeur par défaut [**UnsetValue**](https://msdn.microsoft.com/library/windows/apps/br242371). Cela prêterait à confusion pour les consommateurs de propriété et aurait des conséquences inattendues dans le système de propriétés.
