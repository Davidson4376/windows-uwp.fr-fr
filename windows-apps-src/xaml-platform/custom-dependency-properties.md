...
Exemples de propriétés de dépendance dans le Runtime Windows sont : [**Control.Background**](https://msdn.microsoft.com/library/windows/apps/br209395), [ **FrameworkElement.Width**](/uwp/api/Windows.UI.Xaml.FrameworkElement.Width), et [ **TextBox.Text**](https://msdn.microsoft.com/library/windows/apps/br209702), parmi d’autres d’autres utilisateurs.
...
> [!NOTE]
> Si vous définissez un [ **CreateDefaultValueCallback** ](https://msdn.microsoft.com/library/windows/apps/hh701812) implémentation, vous devez utiliser la méthode utilitaire [ **PropertyMetadata.Create** ](https://msdn.microsoft.com/library/windows/apps/hh702099)au lieu d’appeler un [ **PropertyMetadata** ](https://msdn.microsoft.com/library/windows/apps/br208771) constructeur pour définir le **PropertyMetadata** instance.
...
> [!NOTE]
> N’inscrivez pas avec la valeur par défaut [ **UnsetValue**](https://msdn.microsoft.com/library/windows/apps/br242371). Cela prêterait à confusion pour les consommateurs de propriété et aurait des conséquences inattendues dans le système de propriétés.
