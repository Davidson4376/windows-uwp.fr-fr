...
* Pour utiliser le XAML UWP hébergeant des API dans votre application de bureau, vous devez configurer votre projet pour que vous pouvez appeler des API UWP:
