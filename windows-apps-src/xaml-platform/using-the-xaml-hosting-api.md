...
* Configurer votre projet pour utiliser Windows APIs Runtime et activer des îles de XAML en suivant [ces instructions](xaml-host-controls.md#requirements).
