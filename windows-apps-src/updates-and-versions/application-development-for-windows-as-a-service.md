...
Les **mises à jour qualité** contiennent les résolutions des problèmes de sécurité et d’autres résolutions de bogues importants. Elles sont fournies pour améliorer chaque fonctionnalité actuellement prise en charge, à une cadence d’une à plusieurs par mois. Microsoft continue à publier des mises à jour qualité le mardi («Update Tuesday» ou «Patch Tuesday»). En outre, Microsoft peut publier des mises à jour qualité supplémentaires pour Windows 10 en dehors des mardis si nécessaire pour répondre besoins.

Au cours du développement de Windows 10, Microsoft a simplifié le cycle d’ingénierie et de publication de produits Windows afin que nous pouvons fournir les fonctions, expériences et fonctionnalités que les clients souhaitent plus rapidement que jamais. Nous avons également créé de nouvelles façons de fournir et d’installer les mises à jour des fonctionnalités et les mises à jour qualité, qui simplifient les déploiements et la gestion en cours, élargissent la base des employés pouvant être tenus informés des dernières fonctionnalités et expériences de Windows, et réduisent le coût total de possession. Nous avons donc implémenté de nouvelles options de maintenance – appelées canal semi-annuel et à long terme canal de maintenance (LTSC) – qui offrent des solutions pragmatiques permettant de maintenir davantage d’appareils plus à jour dans les environnements d’entreprise que ce qui était possible auparavant.
...
| Canal de maintenance à long terme (LTSC) | Immédiatement après la publication par Microsoft | 10 ans | Permet le déploiement à long terme de versions sélectionnées de Windows 10 dans les configurations de changement de faible | Entreprise LTSB |
...
-   Si vous utilisez les API [GetVersion](http://go.microsoft.com/fwlink/?LinkID=780555) , gardez à l’esprit que le comportement de cette API a changé depuis Windows8.1.
