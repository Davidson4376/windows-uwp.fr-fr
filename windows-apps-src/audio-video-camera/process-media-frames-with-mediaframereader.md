...
Enfin, la variable *_taskRunning* est redéfinie sur False, de manière à ce que la tâche puisse être de nouveau exécutée lors du prochain appel du gestionnaire.
