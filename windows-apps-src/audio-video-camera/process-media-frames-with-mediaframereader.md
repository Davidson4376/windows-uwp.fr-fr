...
# <a name="process-media-frames-with-mediaframereader"></a>Process media frames with MediaFrameReader
...
## <a name="select-frame-sources-and-frame-source-groups"></a>Select frame sources and frame source groups
...
## <a name="initialize-the-mediacapture-object-to-use-the-selected-frame-source-group"></a>Initialize the MediaCapture object to use the selected frame source group
...
## <a name="set-the-preferred-format-for-the-frame-source"></a>Set the preferred format for the frame source
...
## <a name="create-a-frame-reader-for-the-frame-source"></a>Create a frame reader for the frame source
...
## <a name="handle-the-frame-arrived-event"></a>Handle the frame arrived event
...
## <a name="cleanup-resources"></a>Cleanup resources
...
## <a name="the-framerenderer-helper-class"></a>The FrameRenderer helper class
