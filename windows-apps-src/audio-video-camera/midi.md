...
L’énumération des périphériques de sortie MIDI fonctionne exactement comme l’énumération des périphériques d’entrée, excepté le fait que vous devez spécifier la chaîne de sélecteur renvoyée par [**MidiOutPort.GetDeviceSelector**](https://msdn.microsoft.com/library/windows/apps/dn894845) lors de l’appel de **FindAllAsync**.
