...
| [Graphes audio](audio-graphs.md) | Explique comment utiliser les API dans l’espace de noms [Windows.Media.Audio](https://msdn.microsoft.com/library/windows/apps/dn914341) pour créer des graphiques audio pour le routage, le mixage et les scénarios de traitement audio. |
