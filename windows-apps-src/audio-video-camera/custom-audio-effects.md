...
Le système appelle le [ **fermer** ](https://msdn.microsoft.com/library/windows/apps/dn764782) [ **fermer** ](https://msdn.microsoft.com/library/windows/apps/dn764782) méthode sur votre classe lors de l’effet doit être fermé. Vous devez utiliser cette méthode pour supprimer les ressources que vous avez créées. L’argument de la méthode est un [**MediaEffectClosedReason**](https://msdn.microsoft.com/library/windows/apps/Windows.Media.Effects.MediaEffectClosedReason) qui vous permet de savoir si l’effet a été fermé normalement, si une erreur s’est produite, ou si l’effet ne prend pas en charge le format de codage nécessaire.
