...
> [!IMPORTANT]
> [**OptionalReferencePhotoCaptured** ](https://msdn.microsoft.com/library/windows/apps/mt181392) n’est pas déclenché sur les appareils qui prennent en charge de matériel HDR et par conséquent ne génèrent pas de trames de référence. Votre application doit gérer le cas où cet événement n’est pas déclenché.
