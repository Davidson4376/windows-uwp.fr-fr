...
Avant de pouvoir utiliser votre scanneur de codes-barres Bluetooth vous devez l’associer à l’aide de **> paramètres appareils > Bluetooth & autres > de périphériques Bluetooth ajouter ou un autre appareil**.
