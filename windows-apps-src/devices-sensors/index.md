...
| [Point de service](point-of-service.md) | Cette section décrit comment interagir avec un point de périphériques de service, tels que des analyseurs de code-barres, imprimantes, bacs de trésorerie, etc.. | 
