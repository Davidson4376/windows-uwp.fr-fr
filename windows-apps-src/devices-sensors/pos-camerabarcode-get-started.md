...
ms.locfileid: "57614074"
---
# <a name="getting-started-with-a-camera-barcode-scanner"></a>Prise en main du scanneur de code-barres à caméra
## <a name="step-1-add-capability-declarations-to-your-app-manifest"></a>Étape 1 : Ajoutez les déclarations des fonctionnalités à votre manifeste d’application
...
```
## <a name="step-3-define-your-device-selector"></a>Étape 3 : Définir votre sélecteur d’appareils

### <a name="option-a-find-all-barcode-scanners"></a>**Option a : Rechercher tous les scanneurs de code-barres**

```Csharp
string selector = BarcodeScanner.GetDeviceSelector();       
```

### <a name="option-b-scoping-device-selector-to-connection-type"></a>**Option b : Sélecteur d’appareils d’étendue pour le type de connexion**
...
## <a name="step-4-enumerate-barcode-scanners"></a>Étape 4 : Énumérer les scanners de code-barres
...
### <a name="option-a-enumerate-a-snapshot-of-barcode-scanners"></a>**Option a : Énumérer un instantané des scanneurs de code-barres**
```Csharp
DeviceInformationCollection deviceCollection = await DeviceInformation.FindAllAsync(selector);
```
...
### <a name="option-b-enumerate-and-watch-for-changes-in-available-barcode-scanners"></a>**Option b : Énumérer et de surveiller les modifications de scanneurs de code-barres disponibles**
```Csharp
...
## <a name="step-5-identify-camera-barcode-scanners"></a>Étape 5 : Identifier les scanneurs de code-barres d’appareil photo
...
## <a name="step-6-claim-the-camera-barcode-scanner"></a>Étape 6 : Le scanneur de codes-barres caméra de revendication 
...
## <a name="step-7-system-provided-preview"></a>Étape 7 : Aperçu du système fourni
