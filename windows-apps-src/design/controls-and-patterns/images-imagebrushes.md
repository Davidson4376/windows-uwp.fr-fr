...
-   **Uniform**: L’image est étirée pour s’adapter à la sortie. Mais les proportions du contenu sont conservées. Il s'agit de la valeur par défaut.
...
-   [Classe d’image](https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.controls.image.aspx)
