...
[Bouton partagé](/uwp/api/windows.ui.xaml.controls.splitbutton) | (Version d’évaluation) Un bouton avec deux côtés. Un côté génère une action, et l’autre côté ouvre un menu.
[ToggleSplitButton](/uwp/api/windows.ui.xaml.controls.togglesplitbutton) | (Version d’évaluation) Un bouton bascule avec deux côtés. Un côté Active ou désactive/désactiver, et l’autre côté ouvre un menu.
...
![Un bouton de fractionnement de sélection de couleur de premier plan](images/split-button-rtb.png)
...
![Un bouton de fractionnement de bascule de sélection des styles de liste](images/toggle-split-button-open.png)
