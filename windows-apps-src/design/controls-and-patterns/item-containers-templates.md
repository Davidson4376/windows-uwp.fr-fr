...
Ici, vous définissez un DataTemplate qui montre un [Rectangle](https://docs.microsoft.com/uwp/api/windows.ui.xaml.shapes.rectangle) de la couleur de l’élément, ainsi que le nom de couleur et les valeurs RVB. 
