...
> [!NOTE]
> Cet exemple indique uniquement comment créer la structure de l’interface utilisateur, mais n’affiche pas d’implémentation d’une des commandes.
