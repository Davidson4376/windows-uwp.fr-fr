...
ms.locfileid: "57620794"
---
# <a name="balancing-style-and-consistency"></a>Trouver un juste équilibre entre le style et la cohérence

 

> Remarque: Cet article est une première ébauche pour Windows 10 RS2. Les noms des fonctionnalités, la terminologie et les fonctionnalités sont sujets à des modifications
...
3. La troisième couche permet de personnaliser la navigation aux différents périphériques et contextes. Par exemple, votre navigation avec une interface tactile sur un téléphone sera probablement différente de celle sur un écran 32 pouces avec clavier et souris ou de celle sur un HoloLens avec mouvements et 100 points tactiles sur une surface de 84 pouces.
...
**Si elle a le même aspect, qu’il fonctionnent de la même**
...
**Si un élément est très similaire à un élément existant ou une convention, envisagez d’en faire la même**
...
**Facilité d’utilisation prévaut sur la cohérence**
...
**Faire évoluer des comportements**
