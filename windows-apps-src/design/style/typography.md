...
<div class="uwpd-image-with-caption">
    ...
    <div>Toutes les tailles sont mesurées en pixels effectifs. Pour plus d’informations, voir [Présentation de la conception des applications UWP](../basics/design-and-ui-intro.md).</div>
</div>
