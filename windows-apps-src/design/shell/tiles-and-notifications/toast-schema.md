---
Description: L’article suivant décrit toutes les propriétés et tous les éléments du contenu de notification toast.
...
| **ActivationOptions** | [ToastActivationOptions](#toastactivationoptions) | false | Nouveautés de la mise à jour Creators Update : Options supplémentaires relatives à l’activation de la notification de toast. |
| **Scénario** | [ToastScenario](#toastscenario) | false | Déclare le scénario d’utilisation de votre notification toast, comme une alarme ou un rappel. |
| **DisplayTimestamp** | DateTimeOffset? | false | Nouveautés de la mise à jour Creators Update : Remplacer l’horodatage par défaut avec un horodatage personnalisé représentant lorsque votre contenu de la notification a été remis en fait, au lieu de l’heure de que la notification a été reçue par la plateforme Windows. |
| **En-tête** | [ToastHeader](#toastheader) | false | Nouveautés de la mise à jour Creators Update : Ajouter un en-tête personnalisé à votre notification pour regrouper plusieurs notifications ensemble dans le centre de maintenance. |
...
| **Alarme** | Une notification d’alarme. Elle s’affiche sous sa forme pré-développée et reste sur l’écran de l’utilisateur jusqu’à ce qu’elle soit ignorée. L’audio est diffusé en boucle par défaut et utilise un son d’alarme. |
...
| **Statut** | chaîne ou [BindableString](#bindablestring) | true | Obtient ou définit une chaîne d’état (obligatoire), qui est affichée sous la barre de progression à gauche. Cette chaîne doit refléter l’état de l’opération, par exemple « Téléchargement en cours... » ou « Installation en cours... » |
...
| **ContextMenuItems** | IList<[ToastContextMenuItem](#toastcontextmenuitem)> | false | Nouveautés de la mise à jour anniversaire : Éléments de menu contextuel personnalisé, en fournissant des actions supplémentaires si l’utilisateur avec le bouton droit clique sur la notification. Vous pouvez *combiner* jusqu’à 5 boutons et éléments de menu contextuel. |
...
| **ActivationOptions** | [ToastActivationOptions](#toastactivationoptions) | false | Nouveautés de la mise à jour Creators Update : Obtient ou définit des options supplémentaires relatives à l’activation du bouton de toast. |
...
| **Protocole** | Lancer une autre application en utilisant l’activation de protocole. |
...
| Propriété | type | Requis | Description |
|---|---|---|---|
| **Contenu** | chaîne | true | Obligatoire. Le texte à afficher. |
...
| **ActivationOptions** | [ToastActivationOptions](#toastactivationoptions) | false | Nouveautés de la mise à jour Creators Update : Options supplémentaires relatives à l’activation de l’élément de menu contextuel toast. |
