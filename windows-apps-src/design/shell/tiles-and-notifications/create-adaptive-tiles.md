...
**Remarque**Windows Mobile ne prend pas prendre en charge le logo d’angle, c’est le cas «logo» et «nameandlogo» sont par défaut sur «name» sur un appareil Mobile.
