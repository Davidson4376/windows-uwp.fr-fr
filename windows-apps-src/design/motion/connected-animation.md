...
Pour obtenir les effets différents, certaines configurations ignorent ces propriétés ConnectedAnimationService et utilisent leurs propres valeurs à la place, comme décrit dans le tableau suivant.
