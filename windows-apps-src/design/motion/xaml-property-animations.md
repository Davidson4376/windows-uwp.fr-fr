...
| [Scale](/uwp/api/windows.ui.xaml.uielement.scale) | Vector3 | Mettre à l’échelle l’élément, centrée sur le point central |
...
## <a name="animating-uielement-properties-with-compositionanimation"></a>Animation de propriétés UIElement avec CompositionAnimation
