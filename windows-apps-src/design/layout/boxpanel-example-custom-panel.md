...
> [!NOTE]
> La logique interne de [ **StackPanel** ](https://msdn.microsoft.com/library/windows/apps/br209635) a également ce comportement : **StackPanel** transmet une valeur infinie de dimension à [ **mesure** ](https://msdn.microsoft.com/library/windows/apps/br208952) sur enfants, indiquant qu’il n’existe aucune contrainte quant à enfants dans la dimension de l’orientation. **StackPanel** se dimensionne en général de manière dynamique pour pouvoir accueillir tous les enfants d’une pile qui croît dans cette dimension.
