...
ms.locfileid: "3376185"
---
# <a name="design-toolkits-and-samples-for-uwp-apps"></a>Kits de ressources et exemples de conception pour les applications UWP
 

Création et téléchargement en rapport avec l’interface utilisateur pour les applications de conception/UWP Fluent. Pour obtenir des outils supplémentaires, tels que VisualStudio, consultez <a href="https://developer.microsoft.com/downloads">la page principale des téléchargements</a>. 
...
:::row:::
    :::column:::
        ![image de l’héroïne](images/adobe-xd.png) <b>Adobe XD toolkit</b><br>
        v1806, juin 2018<br>
        <a href="https://aka.ms/adobexdtoolkit">Télécharger</a>
    :::column-end:::
    :::column:::
        ![image de l’héroïne](images/adobe-illustrator.png) <b>toolkit d’Adobe Illustrator</b><br>
        v1806, juin 2018<br>
        <a href="https://aka.ms/adobeillustratortoolkit">Télécharger</a>
    :::column-end:::
    :::column:::
        ![image de l’héroïne](images/sketch.png) <b>esquisse</b><br>
        v1803, mars 2018<br>
...
:::row:::
    :::column:::
        ![image de l’héroïne](images/adobe-photoshop.png) <b>toolkit d’Adobe Photoshop</b><br>
        v1705, mai 2017<br>
        <a href="https://aka.ms/adobephotoshoptoolkit">Télécharger</a>
    :::column-end:::
    :::column:::
        ![image de l’héroïne](images/framer.png) <b>Ixf193xx toolkit</b><br>
        v1806, juin 2018<br>
...
## <a name="developer-toolkits-and-libraries"></a>Les bibliothèques et les kits de développement

:::row:::
    :::column:::
        ![Miniature de bibliothèque WinUI](images/WinUI-library.png) <b>Bibliothèque de l’interface utilisateur de Windows</b><br>
        Les contrôles et autres éléments d’interface utilisateur pour les applications de la série UWP.<br/>
        <a href="/uwp/toolkits/winui/getting-started">Instructions d’installation</a><br/>
    :::column-end:::
    :::column:::
        ![Miniature de communauté Windows](images/Windows-community-toolkit.png) <b>Shared Computer Toolkit de communauté de Windows</b><br>
        Fonctions d’assistance, les contrôles personnalisés et les services d’application.<br />
...
:::row:::
    ...
    :::column-end:::
    ::: étendue de colonnes = «2»::: **Mosaïque et l’icône générateur pour Adobe Photoshop** cet ensemble d’actions pour Adobe Photoshop génère les actifs de mosaïque et icône recommandées 68 à partir de seulement 7 fichiers. <br/><a href="http://go.microsoft.com/fwlink/p/?LinkId=760394">Télécharger le générateur de vignettes et d’icônes</a></p>
    :::column-end:::
:::row-end:::
...
![Galerie de contrôles de XAML](images/xaml-controls-gallery.png)
**Galerie de contrôles de XAML**<br>
