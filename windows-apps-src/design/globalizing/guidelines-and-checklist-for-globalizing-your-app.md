---
Description: Concevez et développez votre application afin qu'elle fonctionne de manière appropriée sur les systèmes avec des configurations de langue et de culture différentes.
...
| Affichez correctement le texte et les polices. | Les paramètres optimaux de police, taille de police et direction du texte varient entre les différents marchés. Pour plus d’informations, consultez [**Ajuster la disposition et les polices, prendre en charge l'écriture DàG**](adjust-layout-and-fonts--and-support-rtl.md) et [Polices internationales](loc-international-fonts.md). |
...
* [Recommandations pour l’utilisation de chaînes](/dotnet/standard/base-types/best-practices-strings?branch=live#recommendations_for_string_usage)
...
* [Exemple de préférences de globalisation](https://go.microsoft.com/fwlink/p/?linkid=231608)
