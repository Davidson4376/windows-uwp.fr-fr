...
* [**TextBlock**](https://msdn.microsoft.com/library/windows/apps/BR209652), [ **RichTextBlock**](https://msdn.microsoft.com/library/windows/apps/BR227565), [ **zone de texte** ](https://msdn.microsoft.com/library/windows/apps/BR209683) et **RichTextBlock** chacun promouvoir la valeur de la **texte** propriété le nom par défaut accessible.
