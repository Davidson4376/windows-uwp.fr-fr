...
Possible Windowsrecognizes deux États pour les interactions de sélection, modifiables et non modifiable et ajuste l’interface utilisateur de sélection, retour et la fonctionnalité en conséquence.
