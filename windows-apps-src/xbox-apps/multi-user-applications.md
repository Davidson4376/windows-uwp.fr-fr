...
> [!NOTE]
> Les applications multi-utilisateurs ne sont pas activées pour le moment. 
...
Pour plus d’informations, voir [KeyRoutedEventArgs.DeviceId](https://msdn.microsoft.com/en-us/library/windows/apps/windows.ui.xaml.input.keyroutedeventargs.deviceid).
