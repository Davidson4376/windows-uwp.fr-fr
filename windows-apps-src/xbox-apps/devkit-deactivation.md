...
1. Accédez à la page [Gérer les consoles XboxOne](https://developer.microsoft.com/xboxdevices) du centre de développement. Vous êtes invité à vous connecter à votre compte du centre de développement.
