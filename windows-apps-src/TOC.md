...
#### [Annonces publicitaires Bluetooth Low Energy (LE)](devices-sensors/ble-beacon.md)
...
#### [Comment reprendre l’exécution d’une application](gaming/how-to-resume-an-app-directx-and-cpp.md)
...
#### [Pratiques d’entrée pour les jeux](gaming/input-practices-for-games.md)
### [Graphismes 2D pour jeux DirectX](gaming/working-with-2d-graphics-in-your-directx-game.md)
### [Graphismes 3D de base pour jeux DirectX](gaming/an-introduction-to-3d-graphics-with-directx.md)
...
#### [Portage de DirectX 9 vers la plateforme Windows universelle (UWP)](gaming/porting-your-directx-9-game-to-windows-store.md)
...
##### [Informations de référence sur le passage d’OpenGL ES 2.0 à Direct3D 11.1](gaming/opengl-es-2-0-to-directx-11-1-reference.md)
...
##### [Textures opaques et alpha 1 bit](graphics-concepts/opaque-and-1-bit-alpha-textures.md)
...
##### [Niveau 1](graphics-concepts/tier-1.md)
##### [Niveau 2](graphics-concepts/tier-2.md)
##### [Niveau 3](graphics-concepts/tier-3.md)
...
##### [Ajouter des publicités à du contenu vidéo en HTML 5 et JavaScript](monetize/add-advertisements-to-video-content.md)
...
### [Services du Windows Store](monetize/using-windows-store-services.md)
...
##### [Obtenir les données relatives aux performances des campagnes publicitaires](monetize/get-ad-campaign-performance-data.md)
#### [Répondre aux avis](monetize/respond-to-reviews-using-windows-store-services.md)
##### [Obtenir des informations de réponse pour les avis sur les applications](monetize/get-response-info-for-app-reviews.md)
##### [Envoyer des réponses aux avis concernant l’application](monetize/submit-responses-to-app-reviews.md)
#### [Exécuter des campagnes publicitaires](monetize/run-ad-campaigns-using-windows-store-services.md)
##### [Gérer les campagnes publicitaires](monetize/manage-ad-campaigns.md)
##### [Gérer les chaînes de distribution des campagnes publicitaires](monetize/manage-delivery-lines-for-ad-campaigns.md)
##### [Gérer les profils de ciblage pour les campagnes publicitaires](monetize/manage-targeting-profiles-for-ad-campaigns.md)
##### [Gérer les contenus des campagnes publicitaires](monetize/manage-creatives-for-ad-campaigns.md)
...
##### [Exemples de code pour l’API de soumission du Windows Store](monetize/code-examples-for-the-windows-store-submission-api.md)
...
### [Création de packages d’applications UWP](packaging/packaging-uwp-apps.md)
### [Créer un package d’application avec l’outil MakeAppx.exe](packaging/create-app-package-with-makeappx-tool.md)
### [Créer un certificat pour la signature de packages](packaging/create-certificate-package-signing.md)
...
#### [API UWP prises en charge pour les applications converties avec Pont du bureau](porting/desktop-to-uwp-supported-api.md)
#### [Guide d’empaquetage Pont du bureau pour les applications de bureau .NET avec Visual Studio](porting/desktop-to-uwp-packaging-dot-net.md)
#### [Déboguer des applications converties avec Pont du bureau](porting/desktop-to-uwp-debug.md)
#### [Signer une application convertie avec Pont du bureau](porting/desktop-to-uwp-signing.md)
...
## [Développement d’applications pour Windows as a service](updates-and-versions/application-development-for-windows-as-a-service.md)
## [Choisir une version d’UWP](updates-and-versions/choose-a-uwp-version.md)
## [Services](https://developer.microsoft.com/windows/develop/microsoft-services)
## [Nouveautés de Windows 10 pour les développeurs](whats-new/windows-10-creators-preview.md)
### [Nouveautés de Windows 10, version 1607](whats-new/windows-10-version-1607.md)
#### [Ajouts d’API dans Windows 10 version 1607](whats-new/windows-10-version-1607-api-diff.md)
### [Nouveautés de Windows 10, version 1607 (version d’évaluation)](whats-new/windows-10-sdk-preview.md)
### [Nouveautés de Windows 10, version 1511](whats-new/windows-10-version-1511.md)
### [Nouveautés de Windows 10, version 1507](whats-new/windows-10-version-1507.md)
...
### [Créer des annonces d’application dans le Windows Store](publish/create-app-store-listings.md)
...
#### [Création d’annonces Windows Store spécifiques à la plateforme](publish/create-platform-specific-store-listings.md)
...
### [Créer des annonces de module complémentaire dans le Windows Store](publish/create-add-on-store-listings.md)
...
### [Générer des packages de préinstallation pour les fabricants d’ordinateurs (OEM)](publish/generate-preinstall-packages-for-oems.md)
## [Analyses](publish/analytics.md)
...
### [Rapport sur les installations](publish/installs-report.md)
...
### [Promouvoir votre rapport d’application](publish/promote-your-app-report.md)
