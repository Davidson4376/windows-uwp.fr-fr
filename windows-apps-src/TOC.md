...
### [Démarrer le FeedbackHub à partir de votre application](monetize/launch-feedback-hub-from-your-app.md)
### [Utiliser les services du WindowsStore](monetize/using-windows-store-services.md)
...
###### [Obtenir un module complémentaire](monetize/get-an-add-on.md)
###### [Créer un module complémentaire](monetize/create-an-add-on.md)
...
###### [Valider une soumission de module complémentaire](monetize/commit-an-add-on-submission.md)
###### [Mettre à jour une soumission de module complémentaire](monetize/update-an-add-on-submission.md)
...
###### [Supprimer une soumission de version d’évaluation de package](monetize/delete-a-flight-submission.md)
...
#### [Convertisseur d’application de bureau](porting/desktop-to-uwp-run-desktop-app-converter.md)
#### [Convertir manuellement une application de bureau Windows en application UWP](porting/desktop-to-uwp-manual-conversion.md)
...
### [Mettre à jour votre projet Microsoft VisualStudio 2015RC UWP vers RTM](porting/update-your-visual-studio-2015-rc-project-to-rtm.md)
...
### [Programmation asynchrone enC++ (applications UWP)](threading-async/asynchronous-programming-in-cpp-universal-windows-platform-apps.md)
...
### [Informations sur laTVA](publish/vat-info.md)
## [Politiques et code de conduite du WindowsStore](https://msdn.microsoft.com/library/windows/apps/dn764939.aspx)
