# [Prise en main de la plateforme Windows universelle](https://developer.microsoft.com/en-us/windows/getstarted)
...
## [Nouveautés de Windows pour les développeurs](whats-new/windows-10-sdk-preview.md)
...
# [Conception et interface utilisateur](https://developer.microsoft.com/en-us/windows/design)
## [Disposition](https://developer.microsoft.com/windows/design/layout)
...
## [Style](https://developer.microsoft.com/windows/design/style)
...
## [Contrôles et modèles](https://developer.microsoft.com/windows/design/controls-patterns)
...
### [Zone de dessin active](controls-and-patterns/active-canvas.md)
### [Barre d’application et barre de commandes](controls-and-patterns/app-bars.md)
...
### [Menus, boîtes de dialogue et fenêtres contextuelles](controls-and-patterns/dialogs-popups-menus.md)
...
#### [Polices](controls-and-patterns/fonts.md)
...
#### [Icônes Segoe MDL2](controls-and-patterns/segoe-ui-symbol-font.md)
...
## [Entrées et appareils](https://developer.microsoft.com/windows/design/inputs-devices)
...
## [Facilité d’utilisation](https://developer.microsoft.com/windows/design/usability)
...
## [Téléchargements](https://developer.microsoft.com/windows/design/assets)
...
### [Utiliser EDP pour protéger les données d’entreprise transférées entre les applications](app-to-app/use-edp-to-protect-enterprise-data-transferred-between-apps.md)
...
### [Protection des données d’entreprise (EDP, Enterprise Data Protection)](enterprise/edp-hub.md)
...
### [Utiliser la protection des données d’entreprise (EDP) pour protéger des fichiers](files/protect-your-enterprise-data-with-edp.md)
### [Utiliser la protection des données d’entreprise (EDP) pour protéger les flux et les mémoires tampons](files/use-edp-to-protect-streams-and-buffers.md)
### [Accès au contenu du Groupement résidentiel](files/quickstart-accessing-homegroup-content.md)
...
## [Monétiser votre application et engager les clients](monetize/index.md)
...
### [Marquage de connexions réseau avec l’identité EDP](networking/tagging_network_connections_with_edp_identity.md)
...
#### [Connecter votre application de bureau convertie](porting/desktop-to-uwp-signing.md)
...
#### [Service Broker de gestionnaire de comptes web](security/web-account-manager.md)
...
### [Présentation des outils Xbox One](xbox-apps/introduction-to-xbox-tools.md)
...
# [Publier des applications Windows](https://developer.microsoft.com/en-us/windows/publish)
...
### [Création des descriptions de PIA](publish/create-iap-descriptions.md)
## [Monétisation à l’aide des annonces](publish/monetize-with-ads.md)
...
## [Politiques et code de conduite du Windows Store](https://msdn.microsoft.com/en-us/library/windows/apps/dn764939.aspx)
### [Politiques du Windows Store](https://msdn.microsoft.com/en-us/library/windows/apps/dn764944.aspx)
#### [Historique des modifications](https://msdn.microsoft.com/en-us/library/windows/apps/dn764945.aspx)
### [Critères de détectabilité des applications](https://msdn.microsoft.com/en-us/library/windows/apps/mt652261.aspx)
### [Code de conduite du développeur](https://msdn.microsoft.com/en-us/library/windows/apps/dn764941.aspx)
