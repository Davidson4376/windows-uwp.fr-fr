...
#### [Create and register an out-of-process background task](launch-resume/create-and-register-an-outofproc-background-task.md)
...
## [Monetization, customer engagement, and Store services](monetize/index.md)
...
#### [In-app purchases and trials using the Windows.ApplicationModel.Store namespace](monetize/in-app-purchases-and-trials-using-the-windows-applicationmodel-store-namespace.md)
...
#### [Create a project and define remote variables in the dashboard](monetize/create-a-project-and-define-remote-variables-in-the-dev-center-dashboard.md)
...
### [Configure your app to receive Dev Center push notifications](monetize/configure-your-app-to-receive-dev-center-notifications.md)
...
##### [Update your app to the latest Microsoft advertising libraries](monetize/update-your-app-to-the-latest-advertising-libraries.md)
##### [Migrate from AdMediatorControl to AdControl for UWP apps](monetize/migrate-from-admediatorcontrol-to-adcontrol.md)
...
##### [Add advertisements to video content in HTML 5 and JavaScript](monetize/add-advertisements-to-video-content.md)
...
###### [Get package rollout info for an app submission](monetize/get-package-rollout-info-for-an-app-submission.md)
###### [Update the package rollout percentage for an app submission](monetize/update-the-package-rollout-percentage-for-an-app-submission.md)
###### [Halt the package rollout for an app submission](monetize/halt-the-package-rollout-for-an-app-submission.md)
###### [Finalize the package rollout for an app submission](monetize/finalize-the-package-rollout-for-an-app-submission.md)
...
###### [Get package rollout info for a package flight submission](monetize/get-package-rollout-info-for-a-flight-submission.md)
###### [Update the package rollout percentage for a package flight submission](monetize/update-the-package-rollout-percentage-for-a-flight-submission.md)
###### [Halt the package rollout for a package flight submission](monetize/halt-the-package-rollout-for-a-flight-submission.md)
###### [Finalize the package rollout for a package flight submission](monetize/finalize-the-package-rollout-for-a-flight-submission.md)
##### [Code examples for the Windows Store submission API](monetize/code-examples-for-the-windows-store-submission-api.md)
...
### [Retail demo app](monetize/retail-demo-experience.md)
...
#### [Prepare an app for conversion with the Desktop Bridge](porting/desktop-to-uwp-prepare.md)
#### [Desktop App Converter](porting/desktop-to-uwp-run-desktop-app-converter.md)
#### [Manually convert your app to UWP using the Desktop Bridge](porting/desktop-to-uwp-manual-conversion.md)
#### [Desktop Bridge app extensions](porting/desktop-to-uwp-extensions.md)
#### [Supported UWP APIs for apps converted with the Desktop Bridge](porting/desktop-to-uwp-supported-api.md)
#### [Debug apps converted with the Desktop Bridge](porting/desktop-to-uwp-debug.md)
#### [Sign an app converted with the Desktop Bridge](porting/desktop-to-uwp-signing.md)
#### [Distribute apps converted with the Desktop Bridge](porting/desktop-to-uwp-distribute.md)
#### [Behind the scenes of the Desktop Bridge](porting/desktop-to-uwp-behind-the-scenes.md)
#### [Known issues with the Desktop Bridge](porting/desktop-to-uwp-known-issues.md)
...
## [What's new in Windows for developers](whats-new/windows-10-version-1607.md)
