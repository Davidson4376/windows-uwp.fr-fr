...
### [Nouveautés de Windows10 version1511](whats-new/windows-10-version-1511.md)
### [Nouveautés de Windows10RTM](whats-new/windows-10-rtm.md)
...
### [Protection des données d’entreprise (EDP, EnterpriseDataProtection)](enterprise/edp-hub.md)
...
##### [Informations de référence sur le passage d’OpenGL ES2.0 vers Direct3D11.1](gaming/opengl-es-2-0-to-directx-11-1-reference.md)
...
### [Marquage de connexions réseau avec l’identitéEDP](networking/tagging_network_connections_with_edp_identity.md)
...
#### [Extensions d’applications de bureau converties](porting/desktop-to-uwp-extensions.md)
...
### [Création de composants Windows Runtime en C# et VisualBasic](winrt-components/creating-windows-runtime-components-in-csharp-and-visual-basic.md)
...
### [Processus de paiement de Microsoft Advertising](publish/microsoft-advertising-payment-process.md)
