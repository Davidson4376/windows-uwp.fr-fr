...
#### [Libérer de la mémoire lorsque votre application bascule en arrière-plan](launch-resume/reduce-memory-usage.md)
### [Lancer une application avec un URI](launch-resume/launch-app-with-uri.md)
#### [Lancer l’application par défaut d’un URI](launch-resume/launch-default-app.md)
...
##### [Ajouter des publicités à des contenus vidéo en HTML 5 et JavaScript](monetize/add-advertisements-to-video-content.md)
