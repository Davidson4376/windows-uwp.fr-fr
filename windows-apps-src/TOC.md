# [Get started with Universal Windows Platform](https://developer.microsoft.com/windows/getstarted)
...
# [Design & UI](https://developer.microsoft.com/windows/design)
...
# [Develop Windows apps](https://developer.microsoft.com/windows/develop)
...
### [Provide social feeds to the People app](contacts-and-calendar/integrating-social-feeds-into-contact-cards.md)
...
### [Connected apps and devices](launch-resume/connected-apps-and-devices.md)
...
### [Handle web-to-app linking with app Uri handlers](launch-resume/web-to-app-linking.md)
...
#### [Create and register a background task that runs in a separate process](launch-resume/create-and-register-a-background-task.md)
#### [Create and register a background task that runs in a single process](launch-resume/create-and-register-a-singleprocess-background-task.md)
#### [Convert a multi-process background task to a single-process background task](launch-resume/convert-multiple-process-background-task.md)
...
### [Communicate with a remote app service](launch-resume/communicate-with-a-remote-app-service.md)
### [Convert an app service to run in the same process as its host app](launch-resume/convert-app-service-single-process.md)
...
#### [Converted desktop app extensions](porting/desktop-to-uwp-extensions.md)
#### [Supported UWP APIs for converted desktop apps](porting/desktop-to-uwp-supported-api.md)
#### [Sign your converted desktop app](porting/desktop-to-uwp-signing.md)
