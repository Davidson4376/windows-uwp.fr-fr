---
author: stevewhims
description: Le SDK Windows inclut C++/WinRT. Il s’agit d’une projection de langage C++ standard pour les API Windows Runtime, implémentée uniquement dans les fichiers d’en-tête et conçue pour vous fournir un accès de première classe à l’API Windows moderne. Avec C++/WinRT, vous pouvez créer et utiliser des API Windows Runtime en utilisant n’importe quel compilateur C++ conforme aux normes.
title: C++/WinRT
ms.author: stwhi
ms.date: 04/10/2018
ms.topic: article
