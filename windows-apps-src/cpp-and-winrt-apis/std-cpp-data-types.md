...
**array_view** a des constructeurs de conversion à partir d’un tableau brut et parmi une plage de **T&ast; ** (pointeurs vers le type d’élément).
