...
Commencez par créer un nouveau projet dans Microsoft Visual Studio. Créer une **Visual C++** > **Windows Desktop** > **Windows Console Application (C++ / WinRT)** de projet et nommez-le *ToastAndCallback*.
...
Vous pouvez commencer la tâche de création d’un serveur de COM in-process en créant un nouveau projet dans Microsoft Visual Studio. Créer une **Visual C++** > **Windows Desktop** > projet de**Bibliothèque de liens dynamiques (DLL)** .

### <a name="set-project-properties"></a>Définition des propriétés de projet

Accédez à **l’onglet Général**des propriétés du projet \> **Version du SDK Windows**et sélectionnez **Toutes les Configurations** et **Toutes les plateformes**. Définissez la **Version du SDK Windows** sur *10.0.17134.0 (Windows 10, version 1803)*, ou version ultérieure.
