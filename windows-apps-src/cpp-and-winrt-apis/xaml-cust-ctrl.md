...
## <a name="add-an-instance-of-bglabelcontrol-to-the-main-ui-page"></a>Ajoutez une instance du **BgLabelControl** à la page principale de l’interface utilisateur
