...
Si les messages d’avertissement vous empêchent de génération, puis les résoudre ou définir la propriété de projet **C/C++** > **générale** > **Treat Warnings As Errors** à **No (/ WX-)** et générez de nouveau le projet.
