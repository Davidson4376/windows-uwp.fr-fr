...
<tbody>
<tr class="odd">
<td align="left"><p>[Formats de gabarit non pris en charge par les ressources de diffusion en continu](stencil-formats-not-supported-with-streaming-resources.md)</p></td>
