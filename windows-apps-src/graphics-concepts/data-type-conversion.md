...
<li>Calcul de FixedMax = 2⁽ⁱ⁻¹⁾ - 2<sup>(-f)</sup></li>
<li>Si n est une valeur NaN, résultat = 0 ; si n est +Inf, résultat = FixedMax*2<sup>f</sup> ; si n est -Inf, résultat = FixedMin*2<sup>f</sup></li>
