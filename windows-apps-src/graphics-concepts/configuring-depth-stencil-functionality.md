...
-   Toutes les cibles de rendu doivent avoir la même taille dans toutes les dimensions (largeur et hauteur et profondeur de taille de tableau ou 3D pour les \*types de tableaux).
...
-   [Decaling](#decaling)
-   [Contours et Silhouettes](#outlines-and-silhouettes)
-   [Gabarit recto-verso](#two-sided-stencil)
-   [Lecture de la mémoire tampon Stencil de profondeur comme une Texture](#reading-the-depth-stencil-buffer-as-a-texture)
...
[Étape de fusion (OM) de sortie](output-merger-stage--om-.md)
