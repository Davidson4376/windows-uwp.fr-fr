...
**Remarque**    certains périphériques sont capables de l’application de textures plusieurs primitives en un seul passage. Voir [Fusion de textures](texture-blending.md).
