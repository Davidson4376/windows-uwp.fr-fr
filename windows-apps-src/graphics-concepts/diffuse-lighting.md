...
Diffuse l’éclairage = somme\[C<sub>d</sub>\*L<sub>d</sub>\*(N<sup>.</sup> L<sub>dir</sub>)\*Atten\*place\]
...
| N               | Non applicable           | D3DVECTOR     | Normale du vertex                                                                                    |
...
| Spot            | Non applicable           | FLOAT         | Facteur de point lumineux. Voir [Atténuation et facteur de point lumineux](attenuation-and-spotlight-factor.md).  |
