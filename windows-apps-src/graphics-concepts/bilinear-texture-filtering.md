...
keywords: "Filtrage de textures bilinéaires"
...
Le *filtrage bilinéaire* calcul la moyenne pondérée des 4texels les plus proches du point d'échantillonnage. Cette approche de filtrage est plus précise et courante que le filtrage des points les plus proches. Cette approche est efficace car elle est implémentée dans le matériel graphique moderne.
