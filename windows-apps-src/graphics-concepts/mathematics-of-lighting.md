...
L’[éclairage émissif](emissive-lighting.md) correspond à la luminosité émise par un objet ; par exemple, une lueur. L’émission rend l’objet affiché auto-lumineux. L’émission affecte la couleur d’un objet. Elle peut, par exemple, procurer de la brillance à un matériau sombre qui récupère une portion de la couleur diffuse.

Un éclairage réaliste peut être obtenu en appliquant chacun de ces types d’éclairage sur une scène 3D. Les valeurs calculées pour les composants ambiants, émissifs et diffus sont produites en tant que couleur diffuse de vertex, tandis que la valeur associée au composant d’éclairage spéculaire est produite en tant que couleur spéculaire de vertex. Les valeurs d’éclairage ambiant, diffus et spéculaire peuvent être affectées par l’atténuation et le facteur de point lumineux d’un éclairage donné. Voir [Atténuation et facteur de point lumineux](attenuation-and-spotlight-factor.md).
...
<tbody>
<tr class="odd">
<td align="left"><p>[Éclairage ambiant](ambient-lighting.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Éclairage diffus](diffuse-lighting.md)</p></td>
<td align="left"><p><em>L’éclairage diffus</em> dépend de la direction de l’éclairage et de la normale à la surface de l’objet. L’éclairage diffus varie à la surface d’un objet, en réponse aux modifications de la direction d’éclairage et du vecteur numéral à la surface. Le calcul de l’éclairage diffus prend davantage de temps, car cette valeur varie pour chaque vertex d’objet. Parallèlement, il permet de nuancer l’illumination des objets et de leur octroyer une profondeur en 3 dimensions.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>[Éclairage spéculaire](specular-lighting.md)</p></td>
<td align="left"><p><em>L’éclairage spéculaire</em> désigne les reflets spéculaires vifs qui surviennent lorsque la lumière atteint la surface d’un objet et se reflète sur la caméra. L’éclairage spéculaire est plus intense que la lumière diffuse et tombe plus rapidement sur la surface de l’objet. Le calcul de l’éclairage spéculaire prend plus de temps que celui de l’éclairage diffus. Toutefois, le fait de l’utiliser permet d’ajouter des informations importantes sur une surface.</p></td>
</tr>
<tr class="even">
<td align="left"><p>[Éclairage émissif](emissive-lighting.md)</p></td>
<td align="left"><p><em>L’éclairage émissif</em> correspond à la luminosité émise par un objet ; par exemple, une lueur. L’émission rend l’objet affiché auto-lumineux. L’émission affecte la couleur d’un objet. Elle peut, par exemple, procurer de la brillance à un matériau sombre qui récupère une portion de la couleur diffuse.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>[Transformations de l’espace de caméra](camera-space-transformations.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Atténuation et facteur de point lumineux](attenuation-and-spotlight-factor.md)</p></td>
