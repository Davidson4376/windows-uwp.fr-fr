...
<span id="determining_the_existing_state_of_ui_automation_support_for_your_custom_ui_class"/>
<span id="DETERMINING_THE_EXISTING_STATE_OF_UI_AUTOMATION_SUPPORT_FOR_YOUR_CUSTOM_UI_CLASS"/>
## Détermination de l’état existant de la prise en charge UI Automation pour votre classe d’interface utilisateur personnalisée  
...
<span id="automation_peer_classes__"/>
<span id="AUTOMATION_PEER_CLASSES__"/>
## Classes homologues d’automation  
...
<span id="peers__patterns_and_control_types"/>
<span id="PEERS__PATTERNS_AND_CONTROL_TYPES"/>
## Homologues, modèles et types de contrôle  
...
<span id="built-in_automation_peer_classes"/>
<span id="BUILT-IN_AUTOMATION_PEER_CLASSES"/>
## Classes homologues d’automation intégrées  
...
<span id="choosing_the_correct_peer_base_class"/>
<span id="CHOOSING_THE_CORRECT_PEER_BASE_CLASS"/>
### Choix de la classe de base d’homologue appropriée  
...
<span id="forwarding_patterns_from_subelements"/>
<span id="FORWARDING_PATTERNS_FROM_SUBELEMENTS"/>
### Transfert de modèles à partir de sous-éléments  
...
* [
            **SetFocusCore**](https://msdn.microsoft.com/library/windows/apps/BR209185_setfocuscore) : appelle la méthode [**Focus**](https://msdn.microsoft.com/library/windows/apps/BR209390_focus).
* [
...
<span id="peers_and_automationproperties"/>
<span id="PEERS_AND_AUTOMATIONPROPERTIES"/>
## Homologues et AutomationProperties  
...
<span id="peer_navigation"/>
<span id="PEER_NAVIGATION"/>
## Navigation parmi les homologues  
...
<span id="native_automation_support_for_text_patterns"/>
<span id="NATIVE_AUTOMATION_SUPPORT_FOR_TEXT_PATTERNS"/>
## Prise en charge de l’automation native pour les modèles de texte  
...
<span id="throwing_exceptions_from_automation_peers"/>
<span id="THROWING_EXCEPTIONS_FROM_AUTOMATION_PEERS"/>
## Levée d’exceptions à partir d’homologues d’automation  
