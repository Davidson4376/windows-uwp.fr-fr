...
<span id="accessible_name"> </span> <span id="ACCESSIBLE_NAME"> </span>Nom accessible
-----------------------------------------------------------------------------------
...
<span id="role_value"> </span> <span id="ROLE_VALUE"> </span>Rôle et valeur
------------------------------------------------------------------------
...
<span id="name_from_inner_text"> </span> <span id="NAME_FROM_INNER_TEXT"> </span>Nom du texte interne
--------------------------------------------------------------------------------------------------
...
**Remarque** Comme l’impose UI Automation, la longueur du nom accessible ne doit pas dépasser 2 048 caractères. Si une chaîne utilisée pour la détermination automatique du nom accessible dépasse cette limite, le nom accessible est tronqué à ce niveau.

 

<span id="images"> </span> <span id="IMAGES"> </span>Noms accessibles pour les images
-----------------------------------------------------------------------------
...
<span id="labels"> </span> <span id="LABELS"> </span>Étiquettes et LabeledBy
----------------------------------------------------------------------
...
<span id="accessible_description"> </span> <span id="ACCESSIBLE_DESCRIPTION"> </span>Description accessible (facultative)
-------------------------------------------------------------------------------------------------------------------
...
<span id="Testing_accessibility_early_and_often"> </span> <span id="testing_accessibility_early_and_often"> </span> <span id="TESTING_ACCESSIBILITY_EARLY_AND_OFTEN"> </span>Test anticipé et régulier de l’accessibilité
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Accessible_names_from_dynamic_data"> </span> <span id="accessible_names_from_dynamic_data"> </span> <span id="ACCESSIBLE_NAMES_FROM_DYNAMIC_DATA"> </span>Noms accessibles tirés de données dynamiques
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Accessible_names_and_localization"> </span> <span id="accessible_names_and_localization"> </span> <span id="ACCESSIBLE_NAMES_AND_LOCALIZATION"> </span>Noms accessibles et localisation
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
