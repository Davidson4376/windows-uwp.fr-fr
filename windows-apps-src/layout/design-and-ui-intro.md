...
La conception d’une application qui s’affiche correctement sur autant d’appareils peut être un véritable défi. Heureusement, la plateforme Windows universelle (UWP) offre un ensemble de fonctionnalités intégrées et des blocs de construction universels qui vous permettent de créer une expérience utilisateur qui fonctionne bien avec divers appareils, écrans et méthodes de saisie. Cet article décrit les fonctionnalités de l’interface utilisateur et les avantages des applicationsUWP, et fournit des recommandations pour la création de votre première applicationUWP. 
...
## <a name="uwp-features"></a>FonctionnalitésUWP

Commençons par jeter un coup d’œil à certaines des fonctionnalités que vous obtenez lorsque vous créez une application UWP.

### <a name="effective-pixels-and-scaling"></a>Pixels effectifs et mise à l’échelle

Les applicationsUWP ajustent automatiquement la taille des contrôles, des polices et des autres éléments d’interface utilisateur afin de se rendre accessibles sur l’ensemble des appareils et de pouvoir facilement interagir avec eux.
...
-   Lorsque le système met à l’échelle l’interface utilisateur, il le fait par multiples de 4. Pour garantir une apparence nette, alignez vos conceptions à la grille de pixels 4 x 4: créez des marges, des tailles et des positions d'éléments d’interface utilisateur sous un multiple de 4pixels effectifs. Notez que le texte n’est pas assujetti à cette exigence; le texte peut avoir n'importe quelle taille et position. 
...
## <a name="uwp-and-the-fluent-design-system"></a>UWP et système de conception Fluent

 Le système de conception Fluent vous aide à créer une interface utilisateur moderne et claire qui incorpore la lumière, la profondeur, le mouvement, les matières et la notion d’échelle. La conception Fluent est appliquée sur les appareils et applications Windows10 pour créer des expériences magnifiques, intuitives et conviviales. 
 
 Comment intégrer la conception Fluent à votre application? Nous ajoutons en permanence de nouveaux contrôles et de nouvelles fonctionnalités qui vous facilitent la vie. Voici une liste des fonctionnalités de conception Fluent actuelles pour UWP:  

* [Matière acrylique](../style/acrylic.md) est un type de pinceau qui crée des surfaces semi-transparentes.
* [Parallaxe](../style/parallax.md) ajoute une perspective 3D, de la profondeur et du mouvement au contenu de défilement, comme des listes.
* [Révéler](../style/reveal.md) utilise la lumière pour créer un effet de pointage qui illumine les éléments d’interface utilisateur interactifs. 
* [Animations connectées](../style/connected-animation.md) permet des transitions de scène progressives qui améliorent la facilité d’utilisation en conservant le contexte et en assurant la continuité. 

Nous avons également mis à jour nos [recommandations en matière de conception](https://developer.microsoft.com/windows/apps/design) (que vous lisez actuellement) afin qu’elles se basent sur les principes de conception Fluent.
...
Nous proposons divers outils pour vous aider à concevoir votre application UWP. Consultez notre [page des kits de ressources de conception](../design-downloads/index.md) pour les kits de ressources XD, Illustrator, Photoshop, Framer et Sketch, ainsi que des outils de conception supplémentaires et des téléchargements de police. 

Pour préparer votre ordinateur afin de pouvoir créer réellement des applications UWP, consultez notre article [Prise en main &gt; Préparation](../get-started/get-set-up.md). 

## <a name="related-articles"></a>Articles connexes

- [Qu’est-ce qu’une application UWP?](https://msdn.microsoft.com/library/windows/apps/dn726767.aspx)
- [Kits de ressources de conception](../design-downloads/index.md)
