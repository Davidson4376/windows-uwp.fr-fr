---
author: mcleanbyron
description: "Utilisez cette méthode dans l’API d’analyse du WindowsStore pour obtenir les données agrégées de conversions par canal d'une application pour une plage de dates données, et en fonction de filtres facultatifs."
...
ms.prod: windows
ms.technology: uwp
keywords: "windows10, uwp, services du WindowsStore, API d’analyse du WindowsStore, conversions d’application, canal"
...
Utilisez cette méthode dans l’API d’analyse du WindowsStore pour obtenir les conversions agrégées par canal d'une application pour une plage de dates données, et en fonction de filtres facultatifs.
...
Ces informations sont également disponibles dans le [rapport Acquisitions](../publish/acquisitions-report.md#app-page-views-and-conversions-by-channel) du tableau de bord du Centre de développement Windows.
