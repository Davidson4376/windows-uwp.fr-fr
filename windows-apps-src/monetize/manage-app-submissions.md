...
<td align="left">[Obtient l’état d’une soumission d’applications existante](get-status-for-an-app-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/submissions```</td>
<td align="left">[Crée une soumission d’applications](create-an-app-submission.md)</td>
</tr>
<tr>
<td align="left">PUT</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/submissions/{submissionId}```</td>
<td align="left">[Met à jour une soumission d’applications existante](update-an-app-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/submissions/{submissionId}/commit```</td>
<td align="left">[Valide une soumission d’applications nouvelle ou mise à jour](commit-an-app-submission.md)</td>
</tr>
<tr>
<td align="left">DELETE</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/submissions/{submissionId}```</td>
<td align="left">[Supprime une soumission d’applications](delete-an-app-submission.md)</td>
</tr>
</tbody>
</table>

<span id="create-an-app-submission">
### Crée une soumission d’applications
...
3. [Créez une soumission d’application](create-an-app-submission.md) en exécutant la méthode suivante dans l’API de soumission du Windows Store. Cette méthode crée une soumission en cours, qui est une copie de votre dernière soumission publiée.
  ...
  Le corps de la réponse contient trois éléments : l’ID de la nouvelle soumission, ses données (notamment toutes les descriptions et informations tarifaires), ainsi que l’URI de signature d’accès partagé (SAS) pour le chargement de tous les packages d’application et de toutes les images de description de la soumission vers le stockage d’objets blob Azure.
...
Pour activer par programmation un lancement de packages progressif pour une soumission d’applications, suivez cette procédure à l’aide des méthodes de l’API de soumission du Windows Store :
...
<td align="left">[Obtient des informations sur le lancement progressif d’une soumission d’applications](get-package-rollout-info-for-an-app-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
...
<td align="left">[Met à jour le pourcentage de lancement progressif d’une soumission d’applications](update-the-package-rollout-percentage-for-an-app-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
...
<td align="left">[Arrête le lancement progressif d’une soumission d’applications](halt-the-package-rollout-for-an-app-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
...
<td align="left">[Finalise le lancement progressif d’une soumission d’applications](finalize-the-package-rollout-for-an-app-submission.md)</td>
</tr>
</tbody>
</table>

<span/>
## Ressources de données Les méthodes de l’API de soumission du Windows Store pour gérer les soumissions d’applications utilisent les ressources de données JSON suivantes.
