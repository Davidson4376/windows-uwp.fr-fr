---
author: mcleanbyron
description: "Utilisez cette méthode dans l’API d’analyse du WindowsStore pour obtenir les données relatives à l'entonnoir d'acquisition d'une application pour une plage de dates données, et en fonction de filtres facultatifs."
...
ms.prod: windows
ms.technology: uwp
keywords: "windows10, uwp, services du WindowsStore, API d’analyse du WindowsStore, acquisition, entonnoir"
...
Utilisez cette méthode dans l’API d’analyse du WindowsStore pour obtenir les données relatives à l'entonnoir d'acquisition d'une application pour une plage de dates données, et en fonction de filtres facultatifs. Ces informations sont également disponibles dans le [rapport Acquisitions](../publish/acquisitions-report.md#acquisition-funnel) du tableau de bord du Centre de développement.
...
Voici quelques exemples de paramètres *filter*.
