...
description: "Utilisez l&quot;API de promotions du Windows Store pour gérer par programmation les campagnes d&quot;annonces promotionnelles pour les applications qui sont enregistrées sur votre compte personnel ou compte d’organisation du Centre de développement Windows."
title: "Exécuter des campagnes de publicité à l’aide des services du Windows Store"
ms.author: mcleans
ms.date: 02/08/2017
ms.topic: article
ms.prod: windows
...
## <a name="step-3-call-the-windows-store-promotions-api"></a>Étape 3 : Appeler l’API de promotions du Windows Store
...
L’exemple de code suivant montre comment obtenir un jeton d’accès Azure AD et appeler l’API de promotions du Windows Store à partir d’une application de console C#. Pour utiliser cet exemple de code, affectez les variables *tenantId*, *clientId*, *clientSecret*, et *appID* aux valeurs appropriées pour votre scénario. Cet exemple requiert le [package Json.NET](http://www.newtonsoft.com/json) de Newtonsoft afin de désérialiser les données JSON renvoyées par l’API de promotions du Windows Store.
