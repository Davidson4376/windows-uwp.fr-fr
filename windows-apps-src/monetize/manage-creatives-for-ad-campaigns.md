...
description: "Utilisez cette méthode dans l’API des promotions du Windows Store pour gérer les contenus créatifs dans le cadre de campagnes publicitaires."
...
>**Remarque**&nbsp;&nbsp;Lorsque vous utilisez cette API pour charger votre propre contenu créatif, la taille maximale autorisée pour votre contenu créatif est de 40Ko. Si vous soumettez un fichier de contenu créatif supérieur, cette API ne renvoie pas une erreur, mais la campagne ne sera pas créée.
...
>**Remarque**&nbsp;&nbsp;Cette API ne prend actuellement pas en charge de méthodePUT.
...
* [Gérer des campagnes publicitaires à l’aide des services du Windows Store](run-ad-campaigns-using-windows-store-services.md)
