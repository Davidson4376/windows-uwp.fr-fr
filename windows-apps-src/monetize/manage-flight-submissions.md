...
description: Utilisez ces méthodes dans l’API de soumission de Microsoft Store pour gérer les envois de vol de package pour les applications qui sont inscrits dans votre compte espace partenaires.
...
> [!IMPORTANT]
> Si vous utilisez l’API de soumission de Microsoft Store pour créer une soumission pour un vol de package, veillez à apporter de modifications à l’envoi uniquement à l’aide de l’API, plutôt que les partenaires. Si vous passez par le tableau de bord pour modifier une soumission initialement créée via l'API, vous ne pourrez plus modifier ou valider cette soumission à l'aide de l'API. Dans certains cas, la soumission non validée peut rester définie sur l'état d'erreur. Si cela se produit, vous devez supprimer la soumission et en créer une nouvelle.
...
<td align="left"><a href="get-a-flight-submission.md">Obtenir une soumission de vol de package existant</a></td>
</tr>
<tr>
<td align="left">GET</td>
...
<td align="left"><a href="get-status-for-a-flight-submission.md">Obtenir l’état d’une soumission de vol de package existant</a></td>
</tr>
<tr>
<td align="left">PUBLIER</td>
<td align="left">https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions</td>
<td align="left"><a href="create-a-flight-submission.md">Créer une nouvelle soumission de vol de package</a></td>
</tr>
<tr>
<td align="left">PUT</td>
<td align="left">https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}</td>
<td align="left"><a href="update-a-flight-submission.md">Mettre à jour une soumission de vol de package existant</a></td>
</tr>
<tr>
<td align="left">PUBLIER</td>
<td align="left">https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/commit</td>
<td align="left"><a href="commit-a-flight-submission.md">Valider l’envoi de vol d’un package nouveau ou mis à jour</a></td>
</tr>
<tr>
<td align="left">Suppression</td>
<td align="left">https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}</td>
<td align="left"><a href="delete-a-flight-submission.md">Supprimer l’envoi de vol d’un package</a></td>
</tr>
</tbody>
</table>
...
1. Si vous ne le n'avez pas encore fait, effectuez les conditions préalables décrites dans [créer et gérer les envois à l’aide des services de Microsoft Store](create-and-manage-submissions-using-windows-store-services.md), y compris l’association d’une application Azure AD avec votre compte espace partenaires et d’obtenir votre ID de client et la clé. Vous n’aurez à le faire qu’une seule fois. Une fois à votre disposition, l’ID client et la clé sont réutilisables chaque fois que vous avez besoin de créer un jeton d’accès Azure AD.  
...
5. [Validez la soumission de la version d’évaluation du package](commit-a-flight-submission.md) en exécutant la méthode suivante. Cela génère une alerte partenaires que vous avez terminé avec votre soumission et que vos mises à jour doivent désormais être appliquées à votre compte.
...
<td align="left"><a href="get-package-rollout-info-for-a-flight-submission.md">Obtenir les informations de lancement progressif pour envoi de vol d’un package</a></td>
</tr>
<tr>
<td align="left">PUBLIER</td>
<td align="left">https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/updatepackagerolloutpercentage</td>
<td align="left"><a href="update-the-package-rollout-percentage-for-a-flight-submission.md">Mettre à jour le pourcentage de lancement progressif pour l’envoi de vol d’un package</a></td>
</tr>
<tr>
<td align="left">PUBLIER</td>
<td align="left">https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/haltpackagerollout</td>
<td align="left"><a href="halt-the-package-rollout-for-a-flight-submission.md">Arrêter le lancement progressif pour l’envoi de vol d’un package</a></td>
</tr>
<tr>
<td align="left">PUBLIER</td>
<td align="left">https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/finalizepackagerollout</td>
<td align="left"><a href="finalize-the-package-rollout-for-a-flight-submission.md">Finaliser le lancement progressif pour l’envoi de vol d’un package</a></td>
</tr>
</tbody>
</table>
...
| languages    | array    |  Tableau des codes des langues prises en charge par l’application. Pour plus d’informations, voir [Langues prises en charge](https://docs.microsoft.com/windows/uwp/publish/supported-languages).    |     
...
* [Gérer les vols de package à l’aide de l’API de soumission de Microsoft Store](manage-flights.md)
