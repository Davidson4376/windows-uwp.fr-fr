...
description: "Utilisez cette méthode dans l’API d’analyse du WindowsStore pour obtenir les données agrégés de performances publicitaires d’une application pour une plage de dates données, et en fonction de filtres facultatifs."
...
ms.prod: windows
ms.technology: uwp
keywords: "windows10, uwp, services du WindowsStore, API d’analyse du WindowsStore, annonces publicitaires, performances"
...
Utilisez cette méthode dans l’API d’analyse du WindowsStore pour obtenir les données agrégés de performances publicitaires de vos applications pour une plage de dates données, et en fonction de filtres facultatifs. Cette méthode renvoie les données au format JSON.
