...
description: "Utilisez cette méthode dans l’API d’analyse du Windows Store pour obtenir les données agrégées de performances publicitaires d’une application pour une plage de dates donnée et en fonction d’autres filtres facultatifs."
...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, services du Windows Store, API d’analyse du Windows Store, annonces publicitaires, performances"
...
Utilisez cette méthode dans l’API d’analyse du Windows Store pour obtenir les données agrégées de performances publicitaires de vos applications pour une plage de dates donnée et en fonction d’autres filtres facultatifs. Cette méthode renvoie les données au format JSON.
