...
L’exemple suivant illustre une demande pour l’obtention des données d’utilisation mensuelle application. Remplacez la valeur *applicationId* par l’ID Windows Store de votre application.
...
| monthlySessionCount       | longue    | Le nombre de sessions d’utilisateur au cours du mois.                                              |
...
| averageDailyActiveUsers   | double  | Le nombre moyen de clients à l’aide de l’application sur une base quotidienne.                             |
| averageDailyActiveDevices | double  | Le nombre moyen des appareils utilisés pour interagir avec votre application par tous les utilisateurs sur une base quotidienne. |
