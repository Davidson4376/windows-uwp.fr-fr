...
title: "Arrêter le lancement de package pour une soumission d’application à l’aide de l’API de soumission du WindowsStore"
...
# Arrêter le lancement de package pour une soumission d’application à l’aide de l’API de soumission du WindowsStore
