...
# Mettre à jour le pourcentage de déploiement du package pour une soumission de version d’évaluation de package à l’aide de l’API de soumission du Windows Store
