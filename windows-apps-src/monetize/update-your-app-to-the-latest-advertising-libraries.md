...
translationtype: HT
---
# <a name="update-your-app-to-the-latest-advertising-libraries"></a>Mettre à jour votre application avec les bibliothèques de publicités les plus récentes

Les applications diffusant des bannières publicitaires dans Microsoft Advertising doivent utiliser **AdControl** ou **AdMediatorControl** à partir de l’un des kits de développement logiciel suivants pour pouvoir continuer à recevoir des bannières publicitaires après 1er avril2017:

  * [MicrosoftStore Services SDK](http://aka.ms/store-services-sdk) (pour les applications UWP)
  * [Kir SDK Microsoft Advertising pour Windows et Windows Phone 8.x](http://aka.ms/store-8-sdk) (pour les applications Windows 8.1 et Windows Phone 8.x)

Avant que ces kits de développement logiciel ne soient disponibles, nous avons lancé ces commandes dans plusieurs anciennes versions de SDK publicitaires plus anciennes, pour les applications Windows et Windows Phone. Ces anciennes versions de kit de développement logiciel publicitaire ne sont plus prises en charge. À compter du 1er avril2017, Microsoft peut cesser de diffuser des bannières publicitaires dans les applications utilisant des anciennes versions de SDK publicitaires, à tout moment et sans préavis.

Si vous disposez d’une application existante (qui se trouve déjà dans le Windows Store ou est en cours de développement) qui affiche des bannières publicitaires à l’aide d'**AdControl** ou d'**AdMediatorControl**, suivez les instructions de cet article pour déterminer si votre application est concernée par ce changement et pour savoir comment mettre à jour votre application si nécessaire.

>**Remarque**&nbsp;&nbsp;En outre,à compter du 1er avril2017, la diffusion des bannières publicitaires pour toute unité publicitaire utilisée dans plusieurs applications sera également interrompue. Pour préparer cette modification, assurez-vous que vos unités publicitaires sont utilisées dans une seule application chacune.

## <a name="more-details-about-this-change"></a>Plus d’informations sur cette modification
...
Si votre application est concernée par ce changement et que vous ne mettez pas à jour votre application pour utiliser le dernier SDK approprié à votre plateforme de ciblage, vous verrez le comportement suivant lors de l'interruption de la diffusion des bannières dans les applications qui utilisent des versions SDK publicitaires non prises en charge:
...
<span id="part-1" />
## <a name="part-1-determine-whether-you-need-to-update-your-app"></a>Partie 1: Déterminez si vous avez besoin de mettre à jour votre application

Suivez les instructions dans les sections suivantes pour déterminer si vous devez mettre à jour de votre application.

### <a name="your-app-uses-adcontrol"></a>Votre application utilise AdControl
...
* Les applications qui ciblent Windows8.0 ne pourront plus recevoir plus de bannières publicitaires à l'avenir. Pour éviter les pertes d’exposition, nous vous recommandons de convertir votre projet en application UWP ciblant Windows10. La plupart du trafic d’applications Windows8.0 s’exécute maintenant sur des appareils dotés de Windows10.
...
### <a name="your-app-uses-admediatorcontrol"></a>Votre application utilise AdMediatorControl
...
### <a name="uwp-projects-for-windows-10"></a>Projets UWP pour Windows10
...
### <a name="windows-81-or-windows-phone-81-xaml-or-javascripthtml-projects"></a>Projets Windows8.1 ou Windows Phone 8.1 (XAML ou JavaScript/HTML)
