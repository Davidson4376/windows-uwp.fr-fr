...
2.  Dans l’espace partenaires, accédez à la page [publicités In-app](../publish/in-app-ads.md) et [créer une unité publicitaire](set-up-ad-units-in-your-app.md#live-ad-units). Pour le type d’unité publicitaire, spécifiez **Bannière**. Prenez note de l’ID d’unité publicitaire et de l’ID de l’application.
    > [!NOTE]
...
4.  Dans votre code, remplacez les mêmes valeurs (**ApplicationId** et **AdUnitId**) par les valeurs dynamiques que vous avez générées dans l’espace partenaires.
