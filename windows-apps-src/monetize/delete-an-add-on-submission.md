...
ms.prod: windows
ms.technology: uwp
keywords: "windows10, uwp, API de soumission du Windows Store, supprimer la soumission d’extension, produit dans l&quot;application, FAI"
...
Utilisez cette méthode de l’API de soumission du Windows Store pour supprimer une extension existante (également connue sous le nom PIA ou produit dans l'application).
