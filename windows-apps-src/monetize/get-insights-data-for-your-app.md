...
| Nomdimension           | chaîne |  Le nom de la métrique décrit dans la dimension actuelle. **EventType**, **marché**, **DeviceType**, **PackageVersion**, **AcquisitionType**, **AgeGroup** et exemples **sexe**.   |
