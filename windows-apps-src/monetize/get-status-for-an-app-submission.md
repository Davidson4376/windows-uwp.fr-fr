...
description: "Utilisez cette méthode dans l’API de soumission du Windows Store pour obtenir l’état d’une soumission d’application."
title: "Obtenir l’état d’une soumission d’application à l’aide de l’API de soumission du Windows Store"
...
# Obtenir l’état d’une soumission d’application à l’aide de l’API de soumission du Windows Store




Utilisez cette méthode dans l’API de soumission du Windows Store pour obtenir l’état d’une soumission d’application. Pour plus d’informations sur le processus de création d’une soumission d’application à l’aide de l’API de soumission du Windows Store, voir [Gérer les soumissions d’applications](manage-app-submissions.md).
...
| submissionId | chaîne | Obligatoire. ID de la soumission dont vous voulez obtenir l’état. Cet ID est disponible dans le tableau de bord du Centre de développement et figure également dans les données de réponse aux requêtes visant à [créer une soumission d’application](create-an-app-submission.md).  |
