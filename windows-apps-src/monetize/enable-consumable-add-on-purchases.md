...
* Vous avez [créé un module complémentaire consommable pour l’application](../publish/add-on-submissions.md) dans le tableau de bord du Centre de développement.
