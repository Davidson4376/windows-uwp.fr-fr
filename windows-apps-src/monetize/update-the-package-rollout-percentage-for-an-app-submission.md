...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, API de soumission du Windows Store, lancement du package, soumission d’application, mise à jour, pourcentage"
...
# <a name="update-the-package-rollout-percentage-for-an-app-submission-using-the-windows-store-submission-api"></a>Mettre à jour le pourcentage de déploiement du package pour une soumission d’application à l’aide de l’API de soumission du Windows Store
