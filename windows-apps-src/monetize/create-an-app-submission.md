...
* Vérifiez que l’application a déjà fait l’objet d’au moins une soumission avec les informations de [classification par âge](https://docs.microsoft.com/windows/uwp/publish/age-ratings) spécifiées.
...
|--------|------------------------------------------------------------------|
| PUBLIER    | `https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/submissions` |
