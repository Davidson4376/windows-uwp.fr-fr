...
2. [Codez votre application à des fins d’expérimentation](code-your-experiment-in-your-app.md). Utilisez une API dans le Microsoft Store Services SDK pour obtenir les valeurs des variables distantes à partir du projet que vous avez créé dans l’espace partenaires, utilisez ces données pour modifier le comportement de la fonctionnalité que vous testez et envoyer des événements d’affichage et les événements de conversion vers l’espace partenaires.
