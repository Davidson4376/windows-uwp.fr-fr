...
description: "Utilisez cette méthode dans l’API des promotions du WindowsStore pour créer, modifier et obtenir des campagnes publicitaires."
...
Appliquez ces méthodes dans l’[API des promotions du WindowsStore](run-ad-campaigns-using-windows-store-services.md) pour créer, modifier et obtenir des campagnes publicitaires pour votre application. Chaque campagne créée via cette méthode peut être associée à une application uniquement.
