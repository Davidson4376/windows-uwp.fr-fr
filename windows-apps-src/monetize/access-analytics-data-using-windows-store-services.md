...
| Insights | <ul><li>[Obtenir des informations pour votre application](get-insights-data-for-your-app.md)</li></ul>  |
...
| Blocs de |  <ul><li>[Obtenir des blocs de mise à niveau pour votre application de bureau](get-desktop-block-data.md)</li><li>[Obtenir des détails sur le bloc de mise à niveau pour votre application de bureau](get-desktop-block-data-details.md)</li></ul> |
...
| Insights | <ul><li>[Obtenir des informations pour votre application de bureau](get-insights-data-for-your-desktop-app.md)</li></ul>  |
...
Comptes pour les développeurs qui font partie du [Centre de développement Windows matériel programme](https://msdn.microsoft.com/windows/hardware/drivers/dashboard/get-started-with-the-hardware-dashboard) ont accès à un ensemble de méthodes pour extraire des données analytique pour les pilotes et le matériel supplémentaire. Pour plus d’informations, voir le [tableau de bord de matériel API](https://docs.microsoft.com/windows-hardware/drivers/dashboard/dashboard-api).
