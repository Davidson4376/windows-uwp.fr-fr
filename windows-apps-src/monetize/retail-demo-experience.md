...
description: Préparer votre application pour le mode de démonstration commerciale, ce qui aide la promotion de votre application sur le sol de vente au détail.
