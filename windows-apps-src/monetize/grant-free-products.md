...
| productId      | string | The Store ID from the Windows Store catalog. For an app, the Store ID is available on the [App identity page](../publish/view-app-identity-details.md) of the Dev Center dashboard. For an add-on, the Store ID is available in the URL of the overview page for the add-on in the Windows Dev Center dashboard. An example Store ID is 9WZDNCRFJ3Q8. | Yes      |
...
| productId               | string         | The Store ID of the line item.                                                               | Yes      |
