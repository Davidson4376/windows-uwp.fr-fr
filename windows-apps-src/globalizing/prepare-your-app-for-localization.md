...
translationtype: HT
---
# <a name="prepare-your-app-for-localization"></a>Préparer votre application en vue de sa localisation
...
## <a name="use-resource-files-and-qualifiers"></a>Utilisez des qualificateurs et des fichiers de ressources.
...
## <a name="add-contextual-comments"></a>Ajoutez des commentaires contextuels.
...
**XAML:** les fichiersResw (ressources créées dans VisualStudio pour les applications enXAML) intègrent un élément «comment». Par exemple:
...
## <a name="localize-sentences-instead-of-words"></a>Localisez des phrases, et non des mots.
...
## <a name="ensure-the-correct-parameter-order"></a>Garantissez l’ordre correct des paramètres.
...
## <a name="do-not-use-the-same-strings-in-dissimilar-contexts"></a>N’utilisez pas de chaînes identiques dans des contextes dissemblables.
...
## <a name="identify-resources-with-unique-attributes"></a>Identifiez les ressources à l’aide d’attributs uniques.
...
## <a name="choose-an-appropriate-translation-approach"></a>Choisissez une approche de traduction appropriée.
...
## <a name="keep-access-keys-and-labels-consistent"></a>Utilisez des touches d’accès rapide et des étiquettes cohérentes.
...
## <a name="support-furigana-for-japanese-strings-that-can-be-sorted"></a>Prenez en charge les furigana pour les chaînes japonaises qui peuvent être triées.
