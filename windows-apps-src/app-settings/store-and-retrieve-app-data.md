...
## Stockage des données d’application dans les magasins de données d’application
...
### Récupérer le magasin de données d’application locale
...
### Créer et récupérer un paramètre local unique
...
### Créer et récupérer une valeur locale composite
...
### Créer et lire un fichier local
...
### Conditions préalables d’itinérance
...
### Créer et récupérer des fichiers d’itinérance
...
### Créer et lire les fichiers temporaires
...
## Organiser les données d’application avec des conteneurs
...
## Supprimer des paramètres et conteneurs d’application
...
* [Recommandations en matière de paramètres de l’application](guidelines-for-app-settings.md)
