...
- La possibilité d’associer un objet avec une lumière afin qu’ils se déplacent indépendamment du reste de la scène pour activer des scénarios tels que Fluent [révéler](/windows/uwp/design/style/reveal) la mise en surbrillance.
...
**Transformations** | Les lumières doivent être placés dans un nœud au-dessus de l’interface utilisateur qui utilise des effets comme les [transformations de perspective](/windows/uwp/design/layout/3-d-perspective-effects) dans votre structure visuelle pour être dessinés correctement.
...
**Modèle de réflexion** | [Facteur de réflexion modèle](/uwp/api/windows.ui.composition.effects.scenelightingeffectreflectancemodel) vous permet de choisir entre [Blinn Phong](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-basic-phong-shader) et physiquement Phong de Blinn en fonction.  Vous choisissez physiquement basée sur une Phong de Blinn lorsque vous souhaitez avoir condensé des surbrillances spéculaires.
