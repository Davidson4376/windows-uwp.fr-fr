...
## <a name="using-an-alternative-mask"></a>À l’aide d’un masque d’autre.

Dans certains cas, vous voudrez à façonner l’ombre telles qu’il ne correspond pas au contenu de votre objet visuel. Pour obtenir cet effet, vous devez définir explicitement la propriété masque à l’aide d’un pinceau avec alpha.
