...
Consultez la section [**Pinceaux**](../graphics/using-brushes.md#xamlcompositionbrushbase) pour en savoir plus sur l’utilisation des pinceaux avec l’interface utilisateur XAML.
...
C’est l’équivalent [C++/CX](https://docs.microsoft.com/cpp/cppcx/visual-c-language-reference-c-cx) du code C&#35; précédent utilisant la même structure XAML.
