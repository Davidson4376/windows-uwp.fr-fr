...
ms.locfileid: "58174127"
---
# <a name="using-the-visual-layer-with-wpf"></a>À l’aide de la couche visuelle avec WPF

Vous pouvez utiliser les API de Composition Windows Runtime (également appelé le [couche visuelle](visual-layer.md)) dans vos applications Windows Presentation Foundation (WPF) pour créer des expériences modernes autrement clair pour les utilisateurs de Windows 10.
...
![L’application en cours d’exécution de l’interface utilisateur](images/interop/wpf-comp-interop-app-ui.png)
