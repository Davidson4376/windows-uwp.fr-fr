...
<tr><td><a href="microsoft-passport-login.md">Créer une application de connexion de Microsoft Passport</a></td><td>Première partie de la procédure complète sur la création d’une application UWP Windows 10 qui utilise Microsoft Passport comme alternative aux systèmes d’authentification par nom d’utilisateur et mot de passe traditionnels.</td></tr>
