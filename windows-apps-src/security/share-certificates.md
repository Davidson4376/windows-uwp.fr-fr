...
## <a name="create-a-windows-store-app-that-uses-certificate-authentication"></a>Créer une application du Windows Store qui utilise l’authentification par certificat
