...
Pour illustrer que la propriété **HostViewModel.NextButtonText** est observable en effet, ajoutez un gestionnaire d’événements **Click** du bouton et mettre à jour la valeur de **HostViewModel.NextButtonText**. Générer, exécuter et cliquez sur le bouton pour afficher la valeur du **contenu** du bouton à mettre à jour.
...
- une clé, qui est le nom d’un auteur, et
