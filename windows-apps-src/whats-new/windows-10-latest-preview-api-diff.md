---
author: QuinnRadich
title: Modifications des API Windows10 version16257
description: "Les développeurs peuvent utiliser la liste suivante pour identifier les nouveaux espaces de noms ou les espaces de noms modifiés dans la version d'évaluation actuelle du SDKWindows10"
keywords: "nouveautés, nouveauté, mise à jour, version d’évaluation, évaluation, API, 16257"
ms.author: quradic
ms.date: 8/17/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16257"></a>Nouvelles API dans le SDKWindows10 version d'évaluation16257

Des espaces de noms d’API nouveaux et modifiés ont été mis à disposition des [Windows Insiders](https://insider.windows.com/) dans le SDKWindows10 version d'évaluation16257.

Vous trouverez ci-dessous une liste complète des ressources de documentation de versions d'évaluation publiées pour les espaces de noms ajoutés depuis la dernière version publique de Windows10, [version1703](windows-10-version-1703-api-diff.md). **Veuillez noter que la documentation de versions d'évaluation peut être incomplète et sujette à modification, et que ces API peuvent être renommées ou supprimées dans les builds suivantes.** Une liste des espaces de noms d'API modifiés ou renommés depuis les versions d’évaluation précédentes du SDK est également jointe.
...
## <a name="apis-changed-or-removed-since-build-16232"></a>API modifiées ou supprimées depuis la build16232

Les API suivantes ont été mises à disposition dans ou avant la build16232, mais ne sont plus présentes dans la build actuelle. Elles ont été renommées ou supprimées entièrement, et la documentation correspondante n’est plus disponible.
...
## <a name="apis-changed-or-removed-since-build-16225"></a>API modifiées ou supprimées depuis la build16225

Les API suivantes ont été mises à disposition dans ou avant la build16225, mais ne sont plus présentes dans la build actuelle. Elles ont été renommées ou supprimées entièrement, et la documentation correspondante n’est plus disponible.
