...
Si vous avez essayé une API expérimentale et souhaitez formuler des commentaires, utilisez la catégorie **Plateforme des développeurs** dans le [Hub de commentaires Windows](https://support.microsoft.com/en-us/help/4021566/windows-10-send-feedback-to-microsoft-with-feedback-hub-app).