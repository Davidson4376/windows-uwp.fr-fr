...
### <span id="Feedback_UI"></span><span id="feedback_ui"></span><span id="FEEDBACK_UI"></span>Interface utilisateur de retour
...
Voici quelques exemples de visualisations de contact intégrées à Windows 8 :

| ![Capture d’écran illustrant une visualisation tactile](images/feedback-touch-cursor.png) | ![Capture d’écran illustrant une visualisation de souris](images/feedback-mouse-cursor2.png) | ![Capture d’écran illustrant une visualisation de stylo](images/feedback-pen-cursor3.png) | ![Capture d’écran illustrant une visualisation de clavier](images/feedback-keyboard-cursor.png) | 
| --- | --- | --- | --- |
| Visualisation tactile | Visualisation de souris/pavé tactile | Visualisation de stylo | Visualisation de clavier |

### <span id="Informational_UI"></span><span id="informational_ui"></span><span id="INFORMATIONAL_UI"></span>Interface utilisateur informative (contextuelle)
...
| Type d’interface utilisateur informative | Chronométrage | Activation | Utilisation |
| --- | --- | --- | --- |
| Info-bulle d’occlusion (pour le frottement et les petites cibles) | 0 ms | Oui | Pour expliquer rapidement une action. Généralement utilisée pour les commandes. |
| Info-bulle d’occlusion (pour les actions) | 200 ms | Oui | |
| Info-bulle évoluée | ~ 2000 ms | Non | Pour une exploration et un apprentissage plus lents et plus délibérés. Généralement utilisée avec des éléments de collection. |
| Interaction auto-révélatrice | ~ 2000 ms | Non | |
| Menu contextuel | ~ 2000 ms | Non | Expose un ensemble limité de commandes lié à l’objet sélectionné. |
| Menus volants | ~ 2000 ms | Non | Expose un ensemble limité de commandes lié à l’objet sélectionné. |
...
### <span id="Tooltips"></span><span id="tooltips"></span><span id="TOOLTIPS"></span>Info-bulles
...
### <span id="Occlusion_tooltips_small"></span><span id="occlusion_tooltips_small"></span><span id="OCCLUSION_TOOLTIPS_SMALL"></span>Info-bulles d’occlusion pour les petites cibles
...
### <span id="Occlusion_tooltips_actions"></span><span id="occlusion_tooltips_actions"></span><span id="OCCLUSION_TOOLTIPS_ACTIONS"></span>Info-bulles d’occlusion pour les actions et les commandes
...
### <span id="Rich_tooltip"></span><span id="rich_tooltip"></span><span id="RICH_TOOLTIP"></span>Info-bulle évoluée
...
### <span id="Context_menu"></span><span id="context_menu"></span><span id="CONTEXT_MENU"></span>Menu contextuel
...
Voir [Ajout de menus contextuels](https://msdn.microsoft.com/library/windows/apps/hh465300).

### <span id="Message_dialog"></span><span id="message_dialog"></span><span id="MESSAGE_DIALOG"></span>Boîte de message
...
### <span id="Flyout"></span><span id="flyout"></span><span id="FLYOUT"></span>Menu volant
