...
---
# <a name="packaging-uwp-apps"></a>Packaging UWP apps
...
## <a name="before-packaging-your-app"></a>Before packaging your app
...
## <a name="configure-an-app-package"></a>Configure an app package
...
## <a name="sideload-your-app-package"></a>Sideload your app package
