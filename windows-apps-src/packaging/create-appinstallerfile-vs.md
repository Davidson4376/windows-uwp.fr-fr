...
Pour distribuer une application via le chargement d'une version test, vous devez créer un package d'application (.appx) ou un ensemble d’applications (.appxbundle) et le publier dans un emplacement partagé.
