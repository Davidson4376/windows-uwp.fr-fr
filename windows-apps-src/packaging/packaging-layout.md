...
Cette disposition de mise en package créera un fichier d’un ensemble d’applications application plate unique avec une x64 package d’architecture et un package d’actifs «Media». 
