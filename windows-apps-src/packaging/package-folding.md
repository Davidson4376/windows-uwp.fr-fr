...
Lorsque votre jeu est installé sur l’ordinateur d’un utilisateur, chaque fichier de package d’application dispose de son propre dossier dans le répertoire **WindowsApps** . De ce fait, pour un utilisateur français exécutant un système Windows 64bits, votre jeu sera similaire à ceci:
