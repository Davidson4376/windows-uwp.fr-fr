...
Lorsque votre jeu est installé sur l’ordinateur d’un utilisateur, chaque fichier de package d’application aura son propre dossier le **WindowsApps** directory. De ce fait, pour un utilisateur français exécutant un système Windows 64 bits, votre jeu sera similaire à ceci :
...
Si vous souhaitez fractionner votre jeu en 3 packages, un package d'architecture x64, un package d'actifs pour les audios et un package d'actifs pour les vidéos ; votre jeu sera divisé en packages comme suit :
