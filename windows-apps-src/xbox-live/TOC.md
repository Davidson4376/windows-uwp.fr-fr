# [Qu’est-ce que Xbox Live ?](index.md)
...
## [API C Xbox Live](xsapi-flat-c.md)
# [Présentation des bacs à sable XBL](xbox-live-sandboxes.md)
# [Configurer Xbox Live](xbox-live-service-configuration.md)
## [Espace partenaires](configure-xbl/windows-dev-center.md)
### [Résumé](configure-xbl/dev-center/summary.md)
### [Installation de Xbox Live](configure-xbl/dev-center/xbox-live-setup.md)
### [Succès 2017](configure-xbl/dev-center/achievements-in-udc.md)
### [Classements et statistiques 2017 proposés](configure-xbl/dev-center/featured-stats-and-leaderboards.md)
...
# [Test sur la console Xbox One](testing-on-console.md)
# [Exemples d’API](samples.md)
# [Nouveautés de Xbox Live](whats-new/whats-new.md)
...
## [Développer dans Visual Studio](get-started-with-creators/develop-creators-title-with-visual-studio.md)
...
### [Prise en charge des contrôleurs sur les préfabriqués XBL](get-started-with-creators/add-controller-support-to-xbox-live-prefabs.md)
### [Prise en charge multi-utilisateur dans Unity](get-started-with-creators/add-multi-user-support.md)
### [Vérifier les paramètres de privilèges utilisateur dans Unity](get-started-with-creators/check-user-privileges-in-unity.md)
## [Configuration du service XBL](get-started-with-creators/xbox-live-service-configuration-creators.md)
## [Présentation des bacs à sable XBL](get-started-with-creators/xbox-live-sandboxes-creators.md)
## [Autoriser les comptes XBL pour le test](get-started-with-creators/authorize-xbox-live-accounts.md)
...
### [Unity pour UWP avec back-end IL2CPP](get-started-with-partner/partner-unity-uwp-il2cpp.md)
### [Unity pour XDK avec back-end IL2CPP](get-started-with-partner/partner-unity-xdk-il2cpp.md)
...
# [Utilisation de Xbox Live](using-xbox-live/using-xbox-live.md)
...
### [Récupérer un utilisateur système Windows : UWP](using-xbox-live/auth/retrieving-windows-system-user-on-UWP.md)
## [Bonnes pratiques pour appeler XBL](using-xbox-live/best-practices/best-practices-for-calling-xbox-live.md)
### [Limitation de débit affinée](using-xbox-live/best-practices/fine-grained-rate-limiting.md)
### [Bonnes pratiques pour le mode hors ligne](using-xbox-live/best-practices/best-practices-for-offline.md)
...
### [Mettre à jour des chaînes](social-platform/rich-presence-strings/rich-presence-strings-updating-strings.md)
### [Bonnes pratiques](social-platform/rich-presence-strings/rich-presence-strings-best-practices.md)
...
### [Programmer Rich Presence](social-platform/rich-presence-strings/programming-rich-presence.md)
...
## [Concevoir des expériences XBL](data-platform/designing-xbox-live-experiences.md)
...
### [Configuration de projet XIM](multiplayer/xbox-integrated-multiplayer/xim-manifest.md)
...
## [Arena sur Xbox](multiplayer/arena/xbox-arena.md)
...
### [Expérience utilisateur - Scénarios d’utilisateur Arena](multiplayer/arena/arena-user-scenarios.md)
## [Chat en cours de jeu 2](multiplayer/chat/game-chat-2-overview.md)
### [Utiliser le chat en cours de jeu 2 (C++)](multiplayer/chat/using-game-chat-2.md)
### [Utiliser le chat en cours de jeu 2 (Projections WinRT)](multiplayer/chat/using-game-chat-2-winrt.md)
### [Manipulation audio en temps réel](multiplayer/chat/real-time-audio-manipulation.md)
### [Migration à partir du chat en cours de jeu](multiplayer/chat/game-chat-2-migration.md)
...
### [Questions fréquentes (FAQ) et résolution des problèmes relatifs au mode multijoueur 2015](multiplayer/multiplayer-appendix/multiplayer-2015-faq.md)
### [Multiplayer Session Directory Xbox One](multiplayer/multiplayer-appendix/xbox-one-multiplayer-session-directory.md)
...
### [Mémoires tampons du Stockage connecté](storage-platform/connected-storage/connected-storage-using-buffers.md)
### [Gérer le Stockage connecté local](storage-platform/connected-storage/connected-storage-xb-storage.md)
### [Bonnes pratiques relatives au Stockage connecté](storage-platform/connected-storage/connected-storage-best-practices.md)
### [Vue d’ensemble technique du Stockage connecté](storage-platform/connected-storage/connected-storage-technical-overview.md)
...
## [Bonnes pratiques](real-time-activity-service/rta-best-practices.md)
...
# [API du SDK WinRT Xbox Live](https://docs.microsoft.com/en-us/dotnet/api/?view=xboxlive-dotnet-2017.11.20171204.01)
# [Informations de référence RESTful Xbox Live](xbox-live-rest/TOC.md)
