...
ms.locfileid: "57621434"
---
# <a name="get-mediamarketplaceidsinglemediagroupsearch"></a>GET (media/{marketplaceId}/singleMediaGroupSearch)
Permet de rechercher des éléments dans un groupe de support unique. Le domaine pour ces URI est `eds.xboxlive.com`.
...
Le code JSON ci-dessous est en réponse à l’appel `/media/en-us/singleMediaGroupSearch?q=vector&desiredMediaItemTypes=DGame&fields=all`.
