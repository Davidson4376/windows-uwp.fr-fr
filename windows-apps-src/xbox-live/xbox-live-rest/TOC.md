# [Référence RESTful des services Xbox Live](atoc-xboxlivews-reference.md)
# [Référence URI (Universal Resource Identifier)](uri/atoc-xboxlivews-reference-uris.md)
...
## [URI du serveur de jeu](uri/gsdk/atoc-gsdk-uri-reference.md)
...
## [URI du gamerpic](uri/gamerpic/atoc-reference-gamerpic.md)
...
## [URI du Marketplace](uri/marketplace/atoc-reference-marketplace.md)
...
## [URI de l'annuaire de sessions](uri/sessiondirectory/atoc-reference-sessiondirectory.md)
...
## [URI de l’historique des titres de succès](uri/titlehistory/atoc-reference-titlehistoryv2.md)
...
# [Référence des objets JSON (JavaScript Object Notation)](json/atoc-xboxlivews-reference-json.md)
...
# [Énumérations utilisées dans des objets JSON (JavaScript Object Notation)](enums/atoc-xboxlivews-reference-enums.md)
...
# [Référence supplémentaires](additional/atoc-xboxlivews-reference-additional.md)
...
## [Affinements de requête EDS](additional/edsqueryrefiners.md)
...
## [Demande HTTP standard et en-têtes de réponse](additional/httpstandardheaders.md)
