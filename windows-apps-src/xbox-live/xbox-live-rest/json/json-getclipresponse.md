...
L’objet GetClipResponse a la spécification suivante.
 
| Membre| Type| Description| 
| --- | --- | --- | 
| gameClip| [GameClip](json-gameclip.md)| Clip de jeu unique qui satisfait la requête.| 
