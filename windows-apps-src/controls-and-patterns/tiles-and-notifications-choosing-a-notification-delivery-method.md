...
Une application dispose de quatre mécanismes pour remettre une notification :
...
<td align="left"><ul>
<li>Une application musicale met à jour sa vignette de façon à afficher la « Lecture en cours ».</li>
