...
-   [**Hyperlink text element (XAML)**](https://msdn.microsoft.com/library/windows/apps/dn279356)
-   [**HyperlinkButton control (XAML)**](https://msdn.microsoft.com/library/windows/apps/br242739)
-   [**a element | a object (HTML)**](https://msdn.microsoft.com/library/windows/apps/hh465917)
...
----------|----------------
![Example of a hyperlink as a text element](images/controls_hyperlink-element.png) | Here's an example of a hyperlink text element that appears inline and flows with the surrounding text:  

HyperlinkButton control| 
----------|----------------
![Example of a hyperlink as a button control](images/controls_hyperlink-button-image.png) | Here's an example of hyperlink buttons. They appear as marked-up text, and can be placed inside a layout container. The Contoso logo image is also a clickable hyperlink:
