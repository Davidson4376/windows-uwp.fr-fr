...
Une fois que l’application a créé un URI de canal, elle l’envoie à son service cloud, ainsi que toutes les métadonnées propres à l’application qui doivent être associées à cet URI.
