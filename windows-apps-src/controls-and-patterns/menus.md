...
Ne vous sentez pas obligé de fournir des icônes pour chaque élément de menu, surtout si le menu est long ou si la commande n’a pas une visualisation standard. Les icônes incompréhensibles ne sont pas utiles: elles créent un encombrement visuel et empêchent les utilisateurs de se concentrer sur les éléments de menu importants.
