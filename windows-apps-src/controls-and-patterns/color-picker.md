...
Si votre application est destinée au dessin ou à des tâches similaires à l’aide du stylet, envisagez d’utiliser les [contrôles pour l’entrée manuscrite](http://windowsstyleguide/controls-and-patterns/inking-controls/) en plus du sélecteur de couleurs.
...
Cet exemple montre comment utiliser la propriété [ColorSpectrumShape](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.colorpicker_colorspectrumshape) pour configurer le sélecteur de couleurs afin qu’il affiche la gamme de couleurs sous forme de cercle, en remplacement du carré par défaut.
...
- [Interactions avec le stylo et le stylet dans les applicationsUWP](../input-and-devices/pen-and-stylus-interactions.md)
