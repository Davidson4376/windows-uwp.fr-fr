...
L’envoi d’une notification brute est semblable à l’envoi d’une notification Push par vignette, toast ou badge avec les différences suivantes :
...
Votre application peut recevoir des notifications brutes à l’aide de deux méthodes :
