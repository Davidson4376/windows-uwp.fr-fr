...
keywords: une application à la communication, communication interprocessus, IPC, messagerie, le service d’application pour une application, en arrière-plan, la communication d’arrière-plan
ms.author: twhitney
ms.date: 09/18/2017
ms.topic: article
