...
description: "Découvrez comment lancer une application à partir d’une autre et échanger des données entre les deux. On parle de « lancement d’une application pour obtenir des résultats »."
