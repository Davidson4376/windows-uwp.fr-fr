...
* **Ne pas créer des activités pour les actions que les utilisateurs devront pas reprendre.** Si votre application est utilisée pour effectuer des opérations simples, à usage unique qui ne sont pas conservées état, probablement inutile créer une activité de l’utilisateur.
