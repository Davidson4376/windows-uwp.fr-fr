...
description: Explique comment déclencher une tâche en arrière-plan à partir d’une application
ms.author: twhitney
ms.date: 07/06/2018
ms.topic: article
ms.prod: windows
