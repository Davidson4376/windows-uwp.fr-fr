...
[Création de packages facultatifs et d’ensembles associés](https://docs.microsoft.com/windows/uwp/packaging/optional-packages)  
[Développement avec les packages d’actif et le pliage de package](../packaging/package-folding.md)  
[Installation par streaming d’application UWP](https://docs.microsoft.com/windows/uwp/packaging/streaming-install)  
