...
Ensuite, dans l’Explorateur de solutions, cliquez sur le projet de votre application (et non le projet de tâche en arrière-plan), puis sur **Propriétés**. Dans la fenêtre Propriétés de l’application, **Déboguer** de gauche, puis sur **ne pas lancer, mais déboguer mon code au démarrage**:
...
![mettre à jour de la version](images/bump-version.png)
