...
> [!NOTE]
> Universal plateforme Windows applications doivent appeler [**RequestAccessAsync**](https://msdn.microsoft.com/library/windows/apps/hh700485) avant d’enregistrer les types de déclencheur en arrière-plan.
