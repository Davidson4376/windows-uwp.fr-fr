...
Cette rubrique explique comment utiliser le **ms-tonepicker :** Schéma d’URI. Ce schéma d’URI peut être utilisé pour :
...
## <a name="task-determine-if-the-tone-picker-is-available-on-the-device"></a>Tâche : Déterminer si le sélecteur de ton est disponible sur l’appareil
```cs
...
## <a name="task-display-the-tone-picker"></a>Tâche : Afficher le sélecteur de ton
...
**Exemple : Ouvrir le sélecteur de ton afin que l’utilisateur peut sélectionner un ton**
...
## <a name="task-display-the-tone-saver"></a>Tâche : Affichage de la veille ton
...
**Exemple : Enregistrer un fichier de musique local une sonnerie**
...
## <a name="task-convert-a-tone-token-to-its-friendly-name"></a>Tâche : Convertir un jeton de ton à son nom convivial
...
**Exemple : Extraire un jeton de ton Contact.RingToneToken et afficher son nom convivial dans la carte de visite.**
