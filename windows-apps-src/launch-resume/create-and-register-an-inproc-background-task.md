...
Pour obtenir un exemple de **OnBackgroundActivated** plus riche, voir [convertir un service d’application pour s’exécuter dans le même processus que son application hôte](convert-app-service-in-process.md).
