...
The topics in this section show how to run your own lightweight code in the background by using background tasks. You can use background tasks to provide functionality when your app is suspended or not running. You can also use background tasks for real-time communication apps like VOIP, mail, and IM.
...
To get started quickly with single-process background tasks, see [Create and register a single process background task](create-and-register-a-singleprocess-background-task.md).

To get started quickly with multi-process background tasks, see [Create and register a background task that runs in a separate process](create-and-register-a-background-task.md).
...
> [!IMPORTANT]
> The **DeviceUseTrigger** and **DeviceServicingTrigger** cannot be used with single-process background tasks.
