...
Pour obtenir des conseils sur le stockage des données de votre application de plateforme Windows universelle, consultez la classe [ApplicationData](https://msdn.microsoft.com/library/windows/apps/windows.storage.applicationdata.aspx).
