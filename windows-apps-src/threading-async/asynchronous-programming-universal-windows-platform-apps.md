...
Avec C / c++ / WinRT, vous utilisez les coroutines et le **co_await** opérateur. Pour plus d’informations et d’exemples de code, consultez [programmation asynchrone en C / c++ / WinRT](../cpp-and-winrt-apis/concurrency.md).
...
Le [ **créer\_fonction async** ](https://msdn.microsoft.com/library/windows/apps/xaml/hh750102.aspx) prend en charge de production des API asynchrones qui peuvent être utilisés à partir de JavaScript ou tout autre langage qui prend en charge de la plateforme Windows universelle. Pour plus d’informations, consultez [création d’opérations asynchrones en C / c++ / CX](https://msdn.microsoft.com/library/windows/apps/xaml/hh750082.aspx).
