...
translationtype: HT
---
#<a name="brokered-windows-runtime-components-for-a-side-loaded-windows-store-app"></a>Composants WindowsRuntime négociés pour les applications installées hors WindowsStore
