...
description: Utilisez Microsoft Visual Studio et d’autres outils pour déboguer et tester votre application, et la préparer pour le processus de certification du Microsoft Store.
ms.date: 02/08/2017
ms.topic: article
...
ms.locfileid: "57582723"
---
# <a name="debugging-testing-and-performance"></a>Débogage, tests et analyse des performances


Cette section vous montre comment utiliser Microsoft Visual Studio pour déboguer, tester et optimiser votre application. Elle inclut également des outils tels que le portail d’appareil Windows (pour la supervision et la configuration des appareils) et le kit de certification des applications Windows (pour la préparation de votre application pour le Microsoft Store).
...
| [Outils de test et de débogage pour la PLM](testing-debugging-plm.md) | Outils et techniques pour le débogage et le test de fonctionnement de votre application avec la Gestion de la durée de vie des processus. |
...
| [Déployer une application par le biais de l’inscription de fichiers libres](loose-file-registration.md) | Ce guide montre comment utiliser la disposition de fichiers libres pour valider et partager des applications Windows 10 sans avoir à les empaqueter. |
...
| [Portail d’appareil Windows](device-portal.md) | Windows Device Portal vous permet de configurer et de gérer à distance votre appareil par le biais d’une connexion réseau ou USB. |
| [Kit de certification des applications Windows](windows-app-certification-kit.md) | Pour maximiser les chances de publication sur le Microsoft Store ou de certification Windows de votre application, validez-la et testez-la sur votre ordinateur avant de l’envoyer pour certification. Cette rubrique explique comment installer et exécuter le Kit de certification des applications Windows. |
...
| [Applications adaptatives de version](version-adaptive-apps.md) | Tirez parti des dernières fonctionnalités et API tout en continuant d’atteindre le public le plus large possible. Utilisez les vérifications des API à l’exécution pour adapter lors de l’exécution votre code et le XAML aux fonctionnalités disponibles sur la version de Windows 10 sur laquelle s’exécute votre application. |
