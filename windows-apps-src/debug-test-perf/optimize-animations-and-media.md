...
### Éviter d’animer un contrôle WebView ou un objet MediaPlayerElement
...
### Retarder la définition de la source d’un objet MediaPlayerElement
...
### Définir MediaPlayerElement.PosterSource
