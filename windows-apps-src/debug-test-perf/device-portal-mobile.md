...
* [Vue d’ensemble du portail d’appareilWindows](device-portal.md)
* [Référence sur les API principales du portail d’appareilWindows](https://docs.microsoft.com/windows/uwp/debug-test-perf/device-portal-api-core)