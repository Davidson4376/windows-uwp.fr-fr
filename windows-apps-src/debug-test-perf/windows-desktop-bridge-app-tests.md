...
**Actions correctives**  
Consultez [bureau pour UWP Bridge : Extensions d’application](https://docs.microsoft.com/windows/apps/desktop/modernize/desktop-to-uwp-extensions) pour une explication de ces extensions et comment les utiliser correctement. 
...
* Il vérifie que chaque fichier binaire managé du package d’application n’est pas dépendant d’une fonction en dehors du profil approuvé. 
