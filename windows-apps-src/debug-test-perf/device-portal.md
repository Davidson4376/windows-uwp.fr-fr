...
> [!IMPORTANT]
> Cette protection empêche toute utilisation de l’API REST à partir d’un client autonome (par exemple, utilitaires de ligne de commande). Cette situation peut être résolue de 3manières différentes: 
