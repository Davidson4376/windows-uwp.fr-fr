...
Xbox | Activer dans le mode de développement | Désactivée | 11443 | Non applicable
...
- [Portail des appareils pour Xbox](device-portal-xbox.md)
...
La page de suivi des performances vous permet d’afficher le [enregistreur de Performance Windows (WPR)](https://msdn.microsoft.com/library/hh448205.aspx) traces à partir de l’appareil hôte.
...
Capturées. Fichiers ETL peuvent être ouverts pour l’analyse dans le [Windows Performance Analyzer](https://msdn.microsoft.com/library/windows/desktop/hh448170.aspx).
