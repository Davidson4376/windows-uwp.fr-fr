...
2. Rechercher adresse IP de votre périphérique. Recherchez l’adresse IP de l’appareil sous **Paramètres > réseau et Internet > Wi-Fi > Propriétés du matériel**. Vous pouvez également demander: «Hey Cortana, quelle est mon adresse IP?»
...
> [!IMPORTANT]
> Si votre PC ne parvient pas à trouver l’appareil, essayez d’utiliser l’adresse IP de réseau réel de l’appareil HoloLens, plutôt que `http://127.0.0.1:10080`.
...
* [Référence sur les API principales du portail d’appareil](https://docs.microsoft.com/windows/uwp/debug-test-perf/device-portal-api-core) (API communes à tous les appareils Windows10)
