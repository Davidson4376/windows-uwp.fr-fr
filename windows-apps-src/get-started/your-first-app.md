...
description: Créez une application de plateforme Windows universelle (UWP) pour Windows10 à l’aide de votre langage de programmation favori.
ms.author: quradic
ms.date: 1/25/2017
ms.topic: article
ms.prod: windows
ms.technology: uwp
keywords: windows10, uwp, prise en main, démarrer, c#, c++, JavaScript
...
Bienvenue dans l’UWP ([Qu’est-ce que l’UWP?](whats-a-uwp.md)) C’est une plateforme! Ces didacticiels visent à vous aider à créer votre première application UWP dans le langage de votre choix.
...
* [Didacticiels UWP](create-uwp-apps.md)
