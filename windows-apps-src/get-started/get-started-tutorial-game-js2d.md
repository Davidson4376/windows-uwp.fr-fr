---
title: Didacticiel de prise en main - Jeu UWP en JavaScript
description: "Jeu UWP simple pour le Windows Store, écrit en JavaScript et CreateJS"
author: jken
ms.author: jken
ms.date: 02/09/2017
ms.topic: article
...
---
# <a name="get-started-tutorial-a-uwp-game-in-javascript"></a>Didacticiel de prise en main: jeu UWP en JavaScript

## <a name="a-simple-2d-uwp-game-for-the-windows-store-written-in-javascript-and-createjs"></a>Jeu UWP2D simple pour le Windows Store, écrit en JavaScript et CreateJS
...
**Remarque:** ce n'est pas un jeu complet (ni excellent). Il sert juste à montrer comment utiliser JavaScript et une bibliothèque tierce pour préparer la publication d'une application sur le Windows Store.
...
Maintenant que vous disposez d'une application UWP, il est possible de la publier dans le Windows Store (en supposant que vous l'avez tout d’abord améliorée!). 
