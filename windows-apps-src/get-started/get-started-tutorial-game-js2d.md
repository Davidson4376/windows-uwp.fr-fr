...
description: Une jeu pour le Microsoft Store, écrite en JavaScript et CreateJS UWP simple
ms.date: 02/09/2017
ms.topic: article
...
**Remarque :** Cela n’est pas un jeu complet (ou bonne) ; Il est conçu pour illustrer l’utilisation de JavaScript et une troisième bibliothèque tierce pour rendre une application prêt à publier sur le Microsoft Store.
...
Appuyez sur **F5** pour démarrer l’exécution de l’application. Vous devez voir une fenêtre ouverte, et notre debout dinosaure familiers dans un paysage être (si elle est partiellement alloué). Nous allons maintenant examiner l’application, expliquer certains éléments importants et découvrir le reste des fonctionnalités au fur et à mesure.
...
Si vous avez démarré le jeu avec F5, vous vous demandez probablement ce qui se passe. À vrai dire « pas grand chose », car une grande partie du code est actuellement commentée. Jusqu’à présent, tout ce que vous voyez est le dinosaure et un appel inopérant à appuyer sur espace. 

### <a name="1-setting-the-stage"></a>1. Préparer le terrain
...
### <a name="3-moving-the-clouds"></a>3. Déplacer les clouds
...
  Le code permettant cela est déjà dans le **main.js** fichier, fourni par la bibliothèque CreateJS, Easeijs. Elle se présente comme suit :
...
### <a name="5-resizing-support"></a>5. Prise en charge de redimensionnement
...
Maintenant vous avez une application UWP, il est possible de publier sur le Microsoft Store (en supposant que vous avez tout d’abord l’amélioré !) 
...
* [Un simple jeu Windows avec JavaScript](https://www.sitepoint.com/creating-a-simple-windows-8-game-with-javascript-game-basics-createjseaseljs/)
* [Sélection d’un moteur de jeu HTML/JS](https://html5gameengine.com/)
* [À l’aide de CreateJS dans votre JS en fonction de jeu](https://blogs.msdn.microsoft.com/cbowen/2012/09/19/using-createjs-in-your-javascript-based-windows-8-game/)
