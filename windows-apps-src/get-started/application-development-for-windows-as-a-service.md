---
title: Application Development for Windows as a service
...
translationtype: HT
---
# <a name="application-development-for-windows-as-a-service"></a>Application development for Windows as a service
...
## <a name="windows-10-release-types-and-cadences"></a>Windows 10 release types and cadences
...
## <a name="supporting-apps-in-windows-as-a-service"></a>Supporting apps in Windows as a service
...
## <a name="key-changes-since-windows-7-to-ensure-app-compatibility"></a>Key changes since Windows 7 to ensure app compatibility
...
## <a name="best-practices-for-app-compatibility"></a>Best practices for app compatibility
...
### <a name="windows-version-check"></a>Windows version check
...
### <a name="undocumented-apis"></a>Undocumented APIs
...
### <a name="develop-universal-windows-platform-uwp-and-centennial-apps"></a>Develop Universal Windows Platform (UWP) and Centennial apps
...
## <a name="optimized-test-strategies-and-flighting"></a>Optimized test strategies and flighting
...
### <a name="step-1-become-a-windows-insider-and-participate-in-flighting"></a>Step 1: Become a Windows Insider and participate in flighting
...
### <a name="step-2-test-your-scenarios"></a>Step 2: Test your scenarios
...
### <a name="step-3-provide-feedback"></a>Step 3: Provide feedback
...
### <a name="step-4-register-on-windows-10"></a>Step 4: Register on Windows 10
