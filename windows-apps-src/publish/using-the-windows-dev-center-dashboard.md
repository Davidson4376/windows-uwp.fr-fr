...
ms.locfileid: "2800230"
---
# <a name="using-the-windows-dev-center-dashboard"></a>Utilisation du tableau de bord du Centre de développement Windows


Le [tableau de bord de centre de développement Windows](https://partner.microsoft.com/dashboard) permet de gérer et envoyer toutes vos applications pour les périphériques Windows à un seul endroit.
...
Lorsque vous [créez une soumission de votre application](app-submissions.md) (pour la première fois ou en tant qu’une mise à jour), vous pouvez la [télécharger les packages d’application](upload-app-packages.md) pour tout pris en charge la version du système d’exploitation et le magasin automatiquement offre aux clients le package appropriées pour les.

[Modules complémentaires (produits dans l’application)](add-on-submissions.md) sont gérées indépendamment l’envoi de votre application. Vous disposez ainsi d’une plus grande souplesse et de la possibilité d’effectuer des modifications de manière indépendante.

Centre de développement Windows propose également des fonctionnalités pour [Ajouter plusieurs utilisateurs](manage-account-users.md),[Gestion des applications et des services](app-management-and-services.md) [d’examen des données analytiques](analytics.md), paiement, [promouvoir vos applications](attract-customers-and-promote-your-apps.md), des [rapports](payout-summary.md) [avec votre clients](engage-with-your-customers.md), [bêta](beta-testing-and-targeted-distribution.md), [les applications métier distribution pour les entreprises](distribute-lob-apps-to-enterprises.md)et bien plus encore.

Vos commentaires nous aident à créer les meilleures fonctionnalités et expériences possibles. Lorsque vous travaillez dans le tableau de bord, utilisez le lien de **commentaires** dans le coin supérieur droit du tableau de bord pour partager vos commentaires et suggestions.
