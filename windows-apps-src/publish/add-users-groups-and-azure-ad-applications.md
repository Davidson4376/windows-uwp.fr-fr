...
title: Ajouter des utilisateurs, groupes et applications Azure AD à votre compte espace partenaires
...
> [!IMPORTANT]
> Pour ajouter des utilisateurs à votre compte, vous devez premier [associer votre compte du centre de partenaires avec le client d’Azure Active Directory de votre organisation](associate-azure-ad-with-dev-center.md). 
...
Pour ajouter des utilisateurs à votre compte espace partenaires, accédez à la page **utilisateurs** dans les **paramètres de compte** , puis sélectionnez **Ajouter des utilisateurs.** Vous devez être connecté avec un compte de gestionnaire pour le client AzureAD que vous souhaitez utiliser. 

### <a name="add-existing-users"></a>Ajouter des utilisateurs existants 

Vous pouvez sélectionner les utilisateurs qui existent déjà dans client de votre organisation et leur donnent accès à votre compte espace partenaires. 

<span id="from-directory" />

1.  Sélectionnez l’icône d’engrenage (près de l’angle supérieur droit de l’espace partenaires), puis sélectionnez les **paramètres de développement**. Dans le menu **paramètres** , sélectionnez **les utilisateurs**.
...
### <a name="create-a-new-group-account-in-your-organizations-directory-and-add-it-to-your-partner-center-account"></a>Créer un nouveau compte de groupe dans l’annuaire de votre organisation et l’ajouter à votre compte espace partenaires

Si vous souhaitez accorder l’accès de l’espace partenaires à un nouveau groupe, vous pouvez créer un nouveau groupe dans la section **des utilisateurs** . Notez que le nouveau groupe sera créé dans l’annuaire de votre organisation, pas seulement dans votre compte espace partenaires.
...
## <a name="add-azure-ad-applications-to-your-partner-center-account"></a>Ajouter des applications Azure AD à votre compte espace partenaires

Vous pouvez autoriser des applications ou services qui font partie de Azure votre organisation AD pour accéder à votre compte espace partenaires. Ces comptes d’utilisateur d’applications AzureAD peuvent être utilisés pour appeler les API REST fournies par les [services MicrosoftStore](../monetize/using-windows-store-services.md).
...
1.  1.  Sélectionnez l’icône d’engrenage (près de l’angle supérieur droit de l’espace partenaires), puis sélectionnez les **paramètres de développement**. Dans le menu **paramètres** , sélectionnez **les utilisateurs**.
...
### <a name="create-a-new-azure-ad-application-account-in-your-organizations-directory-and-add-it-to-your-partner-center-account"></a>Créer une nouvelle application Azure AD du compte dans l’annuaire de votre organisation et l’ajouter à votre compte espace partenaires
...
2.  Apportez les modifications souhaitées. Les éléments que vous pouvez modifier sont les suivants:
    ...
    N’oubliez pas que ces modifications seront effectuées dans l’annuaire de votre organisation, ainsi que dans votre compte espace partenaires.
