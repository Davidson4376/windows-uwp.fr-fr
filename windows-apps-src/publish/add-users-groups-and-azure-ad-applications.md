...
La section [Utilisateurs](manage-account-users.md) du Centre de développement vous permet d’utiliser Azure Active Directory pour ajouter des utilisateurs à votre compte du Centre de développement. Chaque utilisateur reçoit un rôle (ou un ensemble d’autorisations personnalisées) qui définit son accès au compte. Vous pouvez également ajouter des [groupes d’utilisateurs](#groups) et des [applications AzureAD](#azure-ad-applications) pour leur accorder un accès à votre compte du Centre de développement.
...
1.  Dans la page **Utilisateurs**, sélectionnez **Ajouter des utilisateurs**. 
...
Si votre compte comporte des [autorisations d’administrateur global](http://go.microsoft.com/fwlink/p/?LinkId=746654), vous verrez d’autres façons d’ajouter des utilisateurs.

### <a name="additional-methods-for-adding-users"></a>Méthodes supplémentaires d’ajout d’utilisateurs

Si vous êtes connecté avec un compte de gestionnaire qui dispose également des [autorisations d’administrateur global](http://go.microsoft.com/fwlink/?LinkId=746654) pour le client AzureAD sur lequel vous travaillez, vous disposerez d’options supplémentaires pour ajouter des utilisateurs à votre compte du Centre de développement. Vous devrez sélectionner l’une des options suivantes:

-   **Ajouter des utilisateurs existants**: choisissez les utilisateurs qui existent déjà dans l’annuaire de votre organisation et donnez-leur accès à votre compte du Centre de développement, comme décrit ci-dessus.
-   **Créer de nouveaux utilisateurs**: créez de tout nouveau comptes utilisateurs qui seront ajoutés à l’annuaire de votre organisation et à votre compte du Centre de développement.
...
1.  À partir de la page **Utilisateurs**, cliquez sur le nom du compte d’utilisateur que vous souhaitez modifier.
...
1.  Sur la page **Utilisateurs**, cliquez sur **Ajouter des groupes**.
...
1.  Sur la page **Utilisateurs**, sélectionnez **Ajouter des applications AzureAD**.
2.  Sélectionnez une ou plusieurs applications AzureAD dans la liste qui s’affiche. Vous pouvez utiliser la zone de recherche pour rechercher des applications AzureAD spécifiques.
    > [!TIP]
...
1.  Sur la page **Utilisateurs**, cliquez sur le nom de l’application AzureAD.
    > [!TIP]
...
1.  Sur la page **Utilisateurs**, cliquez sur le nom du compte d’utilisateur, de groupe ou d’application AzureAD que vous souhaitez modifier.
...
Sur la page **Utilisateurs**, cliquez sur le lien présent sous **Dernière activité** pour l’utilisateur dont vous souhaitez passer en revue l’historique de navigation. Vous serez en mesure de visualiser les URL de toutes les pages auxquelles a accédé l’utilisateur au cours des 30derniers jours.
