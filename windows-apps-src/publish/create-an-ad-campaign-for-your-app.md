...
3.  Sur la page **Nouvelle campagne**, définissez les paramètres généraux de cette campagne dans la section **Détails de la campagne**.
    ...
    -   Sous **Type de campagne**, choisissez l’une des options suivantes :
        -   **Publicités payées** : ces publicités s’exécutent dans n’importe quelle application correspondant à l’appareil et à la catégorie de votre application.
...
5.  Dans la section **Conception d’annonces**, choisissez l’une des options suivantes :
    -   **Charger mon annonce**. Choisissez cette option pour utiliser vos propres conceptions d’annonces. Vous pouvez charger différents fichiers pour chacune des tailles d’annonce disponibles. Les fichiers doivent répondre aux exigences et directives suivantes :
        -   Chaque fichier doit être un .png ou .jpg inférieur à 2 Mo.
    ...
    -   **Annonce générée automatiquement**. Choisissez cette option pour utiliser les annonces d’une liste de modèles par défaut. Vous disposez des options suivantes pour personnaliser le contenu des annonces. À mesure que vous effectuez des sélections, les aperçus de vos annonces sont automatiquement mis à jour.
...
6.  À présent, choisissez les paramètres financiers de votre campagne de publicité dans la section **Budget et paiement**.
...
7.  Enfin, cliquez sur **Révision** pour vérifier les paramètres de votre campagne de publicité et pour vérifier son budget et les informations de paiement s’il s’agit d’une campagne de publicité payante. Cliquez sur **Confirmer**. Dans les heures qui suivent, vos publicités vont apparaître progressivement sur les appareils Windows ou Windows Phone.
