...
8.  Vérifiez vos informations de budget et de paiement. (Si vous créez une campagne maison ou une campagne de publicité de la communauté, ces options n’apparaîtront pas, car ces campagnes sont gratuites.)
 ...
 Lorsque vous avez terminé, cliquez sur **Enregistrer et Suivant** afin de poursuivre à l’étape **Audience**. (Cette étape n’est pas disponible pour les campagnes de publicité maison, car ces dernières s’exécutent uniquement dans vos propres applications.)
...
9.  Si vous avez choisi **Augmenter l’intérêt pour votre application** comme objectif de campagne, vous pouvez sélectionner l’un des segments de clients à cibler.

    > [!NOTE]
    > Les publicités créées à l’aide de cette campagne sont vues seulement par les clients qui sont inclus dans le segment. Vous ne pouvez sélectionner qu’un segment par campagne de publicité. Pour plus d’informations sur les segments, consultez l’article [Créer des segments de clients](create-customer-segments.md).

 Lorsque vous avez terminé, cliquez sur **Enregistrer et Suivant** afin de poursuivre à l’étape **Conception d’annonces**. (Cette étape n’est pas disponible pour les campagnes de publicité maison, car ces dernières s’exécutent uniquement dans vos propres applications.)
