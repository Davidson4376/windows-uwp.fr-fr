...
> [!IMPORTANT]
> Il se peut que vous ne pourrez pas modifier les réponses que vous validez au Windows Store (sauf si le client modifie), par conséquent, vérifier votre réponse. Si un client modifie son avis initial, votre réponse sera supprimée à partir de la page Description de l’application. Ensuite, vous avez la possibilité de soumettre une nouvelle réponse à l’avis modifié en sélectionnant **mettre à jour votre réponse**.
