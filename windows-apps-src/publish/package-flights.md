...
ms.locfileid: "8934026"
---
# <a name="package-flights"></a>Versions d’évaluation de package

Vous pouvez utiliser des versions d’évaluation de package pour distribuer des packages spécifiques à un groupe limité de testeurs. Les packages que vous avez déjà publiés dans le Store serviront de vos autres clients, afin que leur expérience ne sont pas être interrompue.
