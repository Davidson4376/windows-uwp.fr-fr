...
-   **Estimation des revenus** : l’estimation des revenus sous forme de commissions que vous avez reçues pour les achats approuvés, faits par des utilisateurs ayant cliqué sur les annonces des affiliés dans votre application.
...
> **Remarque** Les données de l’**estimation des revenus**, des **achats (approuvés)** et des **achats (en attente d’approbation)** pour un jour donné peuvent changer suite à l’approbation ou le refus des achats.
