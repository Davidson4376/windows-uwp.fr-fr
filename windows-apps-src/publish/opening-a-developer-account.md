...
7.  Cliquez sur **Suivant** afin d’accéder à la section **Paiement**.
...
10.  Cliquez sur **Terminer** pour confirmer votre inscription. Votre paiement sera traité et nous vous enverrons un message de confirmation à votre adresse de messagerie.
...
> [!IMPORTANT]
> Pour autoriser plusieurs utilisateurs à accéder à votre compte Centre pour développeurs, nous vous recommandons d’à l’aide d’Azure Active Directory pour assigner des rôles des utilisateurs individuels (plutôt que de partage d’accès au compte Microsoft). Chaque utilisateur pourra alors accéder au compte du Centre de développement en se connectant avec ses propres informations d’identification AzureAD. Pour plus d’informations, voir [Gérer les utilisateurs du compte](manage-account-users.md).

Lorsque vous créez un compte de société, ces directives peuvent aider si plusieurs personnes ont besoin accéder au compte en vous connectant avec le compte Microsoft qui a ouvert le compte (au lieu d’utilisateurs individuels ajoutés au centre pour développeurs compte).

-   Créez votre compte Microsoft à l’aide d’une adresse de messagerie qui ne vous appartient pas déjà, ni à une autre personne, telle que MyCompany_DevCenter@outlook.com. N’utilisez pas une adresse de messagerie au domaine de votre entreprise, en particulier si votre société utilisé déjà Azure AD. (Comme mentionné ci-dessus, vous pouvez ajouter des utilisateurs à partir Azure de votre société AD ultérieurement.)
-   Limitez l’accès à ce compte Microsoft au plus petit nombre possible d'utilisateurs.
-   Définir une liste de distribution de messagerie d’entreprise qui inclut toute personne qui doit accéder au compte de développeur, puis ajoutez cette adresse de messagerie pour la [informations de sécurité associées au compte Microsoft [(https://account.microsoft.com/security). Cela permet à tous les employés dans la liste pour recevoir les codes de sécurité envoyés à cet alias. Si vous configurez une liste de distribution n’est pas possible, vous pouvez ajouter l’adresse de messagerie d’une personne à vos informations de sécurité, mais le propriétaire de l’adresse e-mail sera le seul qui peut accéder et partager le code de sécurité lorsque vous y êtes invité (par exemple lorsque les nouvelles informations de sécurité sont ajoutée au t Il compte, ou lorsqu’il est accessible à partir d’un nouveau périphérique).
-   Ajouter un numéro de téléphone société aux informations de sécurité d’un compte Microsoft. Essayez d’utiliser un numéro qui ne nécessite pas une extension et est accessible aux membres de l’équipe.
-   En règle générale, ont les développeurs utilisent des [périphériques approuvés](https://support.microsoft.com/help/12369/microsoft-account-add-a-trusted-device) pour vous connecter à un compte de développeur de votre société. Tous les membres clés de l’équipe doivent avoir accès à ces appareils approuvés. Cela limite le nombre de codes de sécurité devant être envoyés lors de l’accès au compte. En effet, une limite s’applique au nombre de codes pouvant être générés par compte chaque semaine.
...
Vous devez disposer d’au moins deux adresses e-mail et/ou numéros de téléphone pour votre compte Microsoft. Nous recommandons d’en ajouter autant que possible. Gardez à l’esprit que certaines informations de sécurité doivent être confirmées avant d’être valides. En outre, vérifiez fréquemment vos informations de sécurité pour vous assurer qu’elles sont à jour. Vous pouvez gérer vos informations de sécurité en accédant à https://account.microsoft.com/security et en vous connectant à l’aide de votre compte Microsoft. Pour plus d’informations, voir [les informations de sécurité et les codes de sécurité](https://support.microsoft.com/help/12428/microsoft-account-security-info-and-security-codes) .

Lorsque vous vous connectez à votre tableau de bord du centre de développement Windows à l’aide de votre compte Microsoft, le système peut demander de vérifier votre identité en envoyant un code de sécurité que vous devez fournir pour terminer le processus de connexion. Nous vous recommandons de désigner les ordinateurs que vous utilisez fréquemment en tant que *dispositifs approuvés*. Lorsque vous vous connectez à partir d’un périphérique de confiance, vous généralement n’invité pour un code, bien que vous pouvez parfois être invité dans des situations spécifiques ou si vous n’êtes pas inscrit sur ce périphérique pendant une longue période. Pour plus d’informations, voir [Ajouter un périphérique de confiance à votre compte Microsoft](https://support.microsoft.com/help/12369/microsoft-account-add-a-trusted-device) .
