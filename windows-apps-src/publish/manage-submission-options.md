...
Vous pouvez modifier cette date de publication après avoir soumis votre application, à condition que l’étape Publier n’ait pas encore commencé pour l’application. 
...
Notez qu’il existe certaines fonctionnalités restreintes qui seront très rarement approuvées. Pour plus d'informations sur chacune des fonctionnalités restreintes, consultez [Déclarations des fonctionnalités d’application](../packaging/app-capability-declarations.md#special-and-restricted-capabilities).
