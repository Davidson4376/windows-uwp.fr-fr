...
- La colonne **Type** fournit des recommandations d’ordre général sur le type d’informations à fournir pour chaque champ, par exemple, le **texte** ou un **chemin d’accès relatif (ou URL vers le fichier dans l’espace partenaires)**. 
