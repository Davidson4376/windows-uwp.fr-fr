...
|-------------------------------------------------------------|--------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Captures d’écran de bureau](#screenshots)                         | 768 x 1366 ou plus grande                 | Affichées dans votre description de l’application dans le Windows Store lorsqu’elles sont consultées sur un appareil de bureau.                                                                                                          | Recommandées pour toutes les applications, en particulier si votre application est conçue pour une utilisation sur des appareils de bureau. (Au moins une capture d’écran, pour appareil de bureau ou portable, est requise.) |
| [Captures d’écran pour appareils mobiles](#screenshots)                          | 768 x 1 280, 720 x 1 280, ou 480 x 800 | Affichées dans votre description de l’application dans le Windows Store lorsqu’elles sont consultées sur un appareil mobile.                                                                                                           | Recommandées pour toutes les applications, en particulier si votre application est conçue pour une utilisation sur des appareils mobiles. (Au moins une capture d’écran, pour appareil de bureau ou portable, est requise.)  |
...
La page **Description** propose plusieurs champs dans lesquels fournir des captures d’écran pour différents types d’appareils. La soumission de votre application ne nécessite qu’une seule capture d’écran (mais vous pouvez en fournir plusieurs, jusqu’à huit pour mobile et jusqu’à neuf pour ordinateur de bureau). Vous n’êtes pas tenu de proposer des captures d’écran distinctes pour chaque type d’appareil, mais nous recommandons de fournir des captures d’écran pour tous les types d’appareil pris en charge par votre application afin que les clients sachent à quoi cette dernière ressemblera sur leur appareil.

> **Remarque** Microsoft Visual Studio contient un [outil vous permettant d’effectuer ces captures d’écran](http://go.microsoft.com/fwlink/p/?LinkId=221135).
...
Pour les captures d’écran mobile, la taille de chaque capture d’écran doit être de 768 x 1280, 720 x 1280 ou 480 x 800 pixels. Pour un PC de bureau, chaque capture d’écran doit avoir une taille minimale de 768 x 1366 pixels pour un affichage optimal.

Vous pouvez fournir un bref sous-titre pour chaque capture d’écran (au maximum 200 caractères).

> **Remarque** Si votre application [prend en charge plusieurs langues](supported-languages.md), vous accédez à une **Description** pour chaque langue. Vous devez charger des images et des sous-titres séparés pour chaque langue.
...
![instructions relatives à l’image de une](images/spotlight1.jpg)
L’exemple ci-dessous montre une image de une respectant ces proportions. (Les lignes figurant sur l’image montrant comment la conception s’intègre parfaitement dans les zones désignées ne figureront pas dans l’image finale.)
