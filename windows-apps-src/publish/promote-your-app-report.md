...
Le rapport **Ad campaign**, accessible à partir du tableau de bord du Centre de développement Windows, vous permet d’évaluer les performances des campagnes de publicité de votre application.

Pour visualiser le rapport, développez l’option **Attract** du menu de navigation de gauche, puis sélectionnez **Campagnes de publicité** (ou, à partir de l’application, développez **Monétisation**, puis sélectionnez **Promouvoir votre application**). 
