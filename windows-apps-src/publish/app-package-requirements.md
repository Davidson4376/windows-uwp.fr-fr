...
| Propriété du package de l’application | Prérequis                                                          |
|----------------------|----------------------------------------------------------------------|
| Taille de package         | . msixbundle ou. appxbundle: 25 Go maximum par lot <br>Packages. msix ou. AppX ciblant Windows 10: 25 Go maximum par package<br>les packages. AppX ciblant Windows 8.1: 8 Go maximum par package <br> Packages. AppX ciblant Windows 8: 2 Go maximum par package <br> les packages. AppX ciblant Windows Phone 8,1: 4 Go maximum par package <br> Packages. xap: 1 Go maximum par package                                                                           |
