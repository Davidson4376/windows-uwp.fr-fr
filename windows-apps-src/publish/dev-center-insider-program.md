...
|--------------------------------------|------------------------------------|------------|
|**Rapport d’informations**: lorsque nous détectons une anomalie (une modification significative de vos acquisitions, de l’intégrité ou des données d’utilisation), nous fournissons les détails dans ce rapport.  | Dans le menu de navigation de gauche, développez **Analyser**, puis sélectionnez **Informations**. | Mars2018 |
...
|**Aperçu rapide des anomalies**: obtenez un aperçu des modifications importantes relatives à vos acquisitions, votre utilisation et vos données d’intégrité. | Dans les rapports **Acquisitions**, **Utilisation** et **Intégrité**, un marqueur en forme de cercle apparaît à la fin d’une semaine si nous détectons des anomalies (augmentations ou baisses significatives) par rapport à la semaine précédente. Survolez le cercle pour afficher plus d’informations sur ce qui a changé. | Janvier2018 |
