...
![Appareils Windows](images/desktop-to-uwp/windows-devices.png)
...
```
Le [navigateur d’API .NET](https://docs.microsoft.com/dotnet/api/?view=netstandard-2.0) nous montre cependant une alternative. Nous pouvons utiliser les classes ``DbConnection``, ``DbCommand`` et ``DbDataReader``, car ces classes sont disponibles dans .NET Standard2.0.  
...
Pour vous familiariser avec UWP, voir [Introduction à la plateforme Windows universelle](https://docs.microsoft.com/windows/uwp/get-started/universal-application-platform-guide).
...
Des questions? Contactez-nous sur Stack Overflow. Notre équipe contrôle ces [balises](http://stackoverflow.com/questions/tagged/project-centennial+or+desktop-bridge).
