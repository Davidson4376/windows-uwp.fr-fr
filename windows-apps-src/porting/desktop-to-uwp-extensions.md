...
title: Intégrer votre application avec Windows 10 (Pont du bureau)
ms.date: 04/18/2018
ms.topic: article
...
Utiliser des extensions pour intégrer votre application de bureau empaquetée avec Windows 10 manières prédéfinis.
