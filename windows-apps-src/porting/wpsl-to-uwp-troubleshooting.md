...
-   Commencez par déterminer le numéro de version du Kit de développement logiciel (SDK) pour Windows 10 que vous avez installé. Accédez à **C:\\Program Files (x86)\\Windows Kits\\10\\Include\\&lt;nom_dossier_version&gt;** et notez le numéro de version de *&lt;nom_dossier_version&gt;*, qui comporte quatre éléments (« Majeure.Mineure.Build.Révision »).
