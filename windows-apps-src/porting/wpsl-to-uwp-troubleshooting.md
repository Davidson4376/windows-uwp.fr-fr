...
translationtype: HT
---
#  <a name="troubleshooting-porting-windows-phone-silverlight-to-uwp"></a>Résolution des problèmes de portage de Windows Phone Silverlight vers UWP
...
-   Commencez par déterminer le numéro de version du Kit de développement logiciel (SDK) pour Windows10 que vous avez installé. Accédez à **C:\\Program Files (x86)\\Windows Kits\\10\\Include\\&lt;versionfoldername&gt;** et notez la valeur de *&lt;nom_dossier_version&gt;*, à quatre éléments (« Major.Minor.Build.Revision »).
