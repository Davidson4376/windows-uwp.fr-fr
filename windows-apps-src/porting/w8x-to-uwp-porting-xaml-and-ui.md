...
**Remarque**  l’état visuel PointerOver est adapté styles/modèles personnalisés dans les applications Windows 10 et dans les applications Windows Runtime 8.x, mais non dans les applications Windows Phone Store. Pour cette raison (et, en raison de clés de ressources système qui sont pris en charge pour les applications Windows 10), nous recommandons que vous réutiliser les styles/modèles personnalisés à partir d’applications Windows Runtime 8.x lorsque vous portez votre application pour Windows 10.
...
Dans une application Windows Phone Store, le zoom arrière viewexpands à thesize de l’écran. Dans une application de 8.x Windows Runtime et dans une application Windows 10, la taille de la vue avec zoom arrière est restreinte par les limites du contrôle **SemanticZoom** .
