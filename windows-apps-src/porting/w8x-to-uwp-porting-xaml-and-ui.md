...
| [**TextBox**](https://msdn.microsoft.com/library/windows/apps/br209683) | Dans une application de 8.x Windows Runtime, orthographe est désactivée par défaut pour un [**contrôle TextBox**](https://msdn.microsoft.com/library/windows/apps/br209683). Dans une application Windows Phone Store et dans une application Windows 10, elle est activée par défaut. |
...
Voici les aspects de [**GridView**](https://msdn.microsoft.com/library/windows/apps/br242705) et [**ListView**](https://msdn.microsoft.com/library/windows/apps/br242878) qui ont modifier ni ne sont pas pris en charge dans Windows 10.
