...
![Application bookstore2\-81 sur WindowsPhone (vue avec zoom avant)](images/w8x-to-uwp-case-studies/c02-03-wp81-zi-how-the-app-looks.png)

Application Bookstore2\_81 sur WindowsPhone (vue avec zoom avant)

![Application bookstore2\-81 sur WindowsPhone (vue avec zoom arrière)](images/w8x-to-uwp-case-studies/c02-04-wp81-zo-how-the-app-looks.png)
...
Tout comme dans l’étude de cas précédente, l’option que nous allons prendre (ceux décrits dans [Si vous disposez d’une application 8.1 universelle](w8x-to-uwp-root.md)) est à porter le contenu de la Shared projeter vers un Windows 10 qui cible la famille d’appareils universelle.
...
Vous pouvez maintenant générer l’application et l’exécuter. Voici comment notre nouvelle application UWP à ressemble aucun travail encore pour le portage vers Windows 10.
