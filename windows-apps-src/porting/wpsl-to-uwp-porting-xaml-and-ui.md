...
## Liaison et liaisons compilées avec {x: Bind}
...
**Remarque** L’état visuel PointerOver est adapté aux styles/modèles personnalisés dans les applications Windows 10, mais non dans les applications Silverlight pour Windows Phone. Il existe d’autres raisons pour lesquelles vos styles/modèles personnalisés existants peuvent ne pas convenir pour les applications Windows10, notamment les clés de ressources système que vous utilisez, les modifications apportées aux jeux d’états visuels utilisés et les améliorations de performances appliquées aux styles/modèles par défaut de Windows10. Nous vous recommandons de modifier une nouvelle copie d’un modèle de contrôle par défaut pour Windows 10, puis de lui réappliquer votre style et votre personnalisation de modèle.
...
## Référence aux clés de ressources
...
## Barre d’état (zone de notification)
...
![styles textblock système pour les applications windows10](images/label-uwp10stylegallery.png) styles TextBlock système pour les applications Windows10
