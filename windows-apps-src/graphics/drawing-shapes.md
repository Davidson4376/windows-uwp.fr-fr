...
description: "Découvrez comment dessiner des formes, telles que des ellipses, des rectangles, des polygones et des tracés. La classe Path permet de visualiser un langage de dessin vectoriel complexe dans une interface utilisateur XAML. Par exemple, vous pouvez dessiner des courbes de Bézier."
ms.author: jimwalk
ms.date: 02/08/2017
ms.topic: article
ms.prod: windows
