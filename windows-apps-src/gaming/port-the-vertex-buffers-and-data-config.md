...
description: "Lors de cette étape, vous allez définir les tampons de sommet qui contiendront vos maillages ainsi que les tampons d’index qui permettront aux nuanceurs de parcourir les sommets dans l’ordre indiqué."
