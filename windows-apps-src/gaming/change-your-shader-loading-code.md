...
description: "D’un point de vue conceptuel, le pipeline nuanceur de Direct3D11 est très similaire à celui d’OpenGLES2.0."
...
# Comparer le pipeline nuanceur d’OpenGLES2.0 à celui de Direct3D
