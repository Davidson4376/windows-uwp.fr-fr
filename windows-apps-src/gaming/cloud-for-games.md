...
<table>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li><a href="https://customers.microsoft.com/story/tencent-telecommunications-azure-service-fabric-windows-server-en">Tencent Games et Microsoft conçu la solution de jeu de cloud</a>
                <li><a href="https://channel9.msdn.com/Shows/Cloud+Cover/Episode-228-Building-Games-with-Service-Fabric#time=38m33s">Création de jeux avec Service Fabric : Plus d’informations sur l’implémentation de Tencent (vidéo)</a>
            </ul>
        </td>
    </tr>
    <tr>
        <td><a href="https://www.halowaypoint.com/">343 secteurs</a></td>
        <td><b>Halo 5 : Gardiens</b> implémenté <a href="https://www.halowaypoint.com/spartan-companies">Halo : Les entreprises Spartan</a> en tant que sa plateforme de la société à l’aide d’Azure Cosmos DB (via l’API DocumentDB), ce qui a été sélectionné pour sa vitesse et la flexibilité en raison de ses fonctionnalités de l’indexation automatique.</td>
        <td>
            <ul>
        ...
        <td>
            <ul>
                <li><a href="https://azure.microsoft.com/blog/how-halo-5-guardians-implemented-social-gameplay-using-azure-documentdb/">A implémenté à l’aide d’Azure Cosmos DB (via l’API DocumentDB)</a>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Next Games est le créateur de <b>The Walking Dead : No Man's Land de populaire</b> jeu vidéo qui est basée sur la série d’AMC d’origine. Le jeu The Walking Dead utilisait Azure comme serveur principal. Il était de 1 000 000 téléchargements dans la première semaine et au sein de la première semaine, le jeu est devenu #1 iPhone et iPad gratuit application aux États-Unis. App Store, #1 application gratuite dans 12 pays et #1 jeu gratuit dans 13 pays.
        </td>
        <td>
            <ul>
        ...
        <td>
            <ul>
                <li><a href="https://azure.microsoft.com/blog/how-we-built-it-next-games-global-online-gaming-platform-on-azure/">Comment le proposons-nous : Plateforme de jeux en ligne global jeux suivant sur Azure (blog avec vidéo)</a>
                <li><a href="https://azure.microsoft.com/blog/the-walking-dead-no-mans-land-game-soars-to-1-with-azure-documentdb/">Walking Dead utilise Azure Cosmos DB (via l’API DocumentDB) pour le cycle de développement plus rapide et plus attrayante de jeu</a>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><a href="https://channel9.msdn.com/Blogs/The-Game-Blog/BizSpark-Interview-with-Pixel-Squad-How-the-used-Azure-Cloud-Services-to-make-an-MMO-with-a-3-man-te">Utilisation de jeu de Crime côte MMO Azure Cloud Services</a>
            </ul>
        </td>
    </tr> 
</table>
...
* [Hitman et Azure : Créer des fonctions de jeu comme insaisissables cible qui ne sont possibles à l’aide de cloud](https://channel9.msdn.com/Series/Hitman)
* [Azure en tant que l’ingrédient secret pour Hitcents, jeu Troopers et InnoSpark](https://news.microsoft.com/features/game-developers-use-microsoft-azure-as-secret-sauce-for-scale-and-growth-2/)
* [Startups de jeux sur le programme Bizspark à l’aide d’Azure](https://blogs.technet.microsoft.com/bizspark_featured_startups/2015/09/25/azure-open-for-gaming-startups/)
...
| Jeu cloud hautement disponible et évolutif multiniveaux avec plus de contrôle du système d’exploitation (PaaS)        | Le jeu est hébergé sur une plateforme gérée                | [Service Cloud Azure](https://azure.microsoft.com/services/app-service/) | PaaS conçu pour prendre en charge des applications au fonctionnement évolutif, fiable et peu coûteux   |
...
| Tables de stockage de données temporaires| Les transactions de jeu (changements dans les états de jeu) sont stockées temporairement dans les tables | [Stockage Table Azure](https://azure.microsoft.com/services/storage/tables/)| Les données de jeu peuvent être stockées dans un schéma flexible en fonction des besoins du jeu |
| Mise en file d’attente des transactions/requêtes de jeu| Les transactions de jeu sont traitées sous la forme d’une file d’attente | [Stockage de file d’attente Azure](https://azure.microsoft.com/services/storage/queues/)| Les files d’attente absorbent les pics de trafic inattendus et peuvent empêcher les serveurs d’être submergés par un flux soudain de demandes en cours de jeu   |
...
* [Microsoft for Startups](https://startups.microsoft.com)
    ...
    Microsoft for Startups offre des techniques et des produits, ainsi que des avantages pour la mise sur le marché, afin d’accélérer la croissance des start-up. Parmi ces avantages on trouve notamment l’accès gratuit à un compte Azure. Vous disposez de 200 $ de crédit pour explorer des services pendant 30 jours, d’un accès gratuit à des services populaires pendant 12 mois et d’un accès gratuit illimité à plus de 25 services. Pour plus d’informations, consultez la rubrique [Donnez vie aux idées de votre startup avec un compte gratuit Azure](https://azure.microsoft.com/free/startups/).
    
* [Programmes de développement](e2e.md#developer-programs)

    Microsoft propose plusieurs programmes pour développeurs tels que [ID@Xbox](https://www.xbox.com/Developers/id) et le [Programme Créateurs Xbox Live](https://developer.microsoft.com/games/xbox/xboxlive/creator) pour vous aider à développer et à publier des jeux.

## <a name="learning-resources"></a>Ressources de formation

* build 2016 : [CodeLabs &mdash; backend utiliser Microsoft Azure App Service et Microsoft SQL Azure pour enregistrer un score de jeu dans Unity](https://github.com/Microsoft-Build-2016/CodeLabs-GameDev-6-Azure)
* build 2017 : [Fourniture de jeux hautes performances expériences à l’aide de Microsoft Azure : Leçons tirées des titres tels que Halo, Hitman et Walking Dead (vidéo)](https://channel9.msdn.com/Events/Build/2017/P4062)
* Ensemble réutilisable de blocs de construction, les projets, les services et les bonnes pratiques conçus pour prendre en charge les charges de travail jeux courantes à l’aide d’Azure sur GitHub : [Blocs de construction pour les jeux sur Azure](https://github.com/MicrosoftDX/nether)
* [Services de Gaming sur Azure (vidéos)](https://channel9.msdn.com/Series/Gaming-Services-on-Azure)
...
[Playfab](https://playfab.com/) alimente actuellement plus de 1 200 jeux en direct avec 80 millions de joueurs actifs tous les mois. Il s’agit d’une plateforme principale complète qui inclut la pile complète LiveOps avec le contrôle en temps réel. 
