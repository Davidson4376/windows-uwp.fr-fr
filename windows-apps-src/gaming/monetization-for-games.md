...
### Types de composants additionnels
...
#### Publier le jeu comme étant masqué
...
#### Associer votre solution de jeu avec le Windows Store
...
#### Créer un composant additionnel dans le Windows Store
...
### Quelles publicités s’affichent?
...
### API pour afficher des publicités
...
### Se préparer au lancement en remplaçant les valeurs de test de l’unité publicitaire
...
## Optimiser le potentiel de votre jeu par le biais de campagnes de publicité
