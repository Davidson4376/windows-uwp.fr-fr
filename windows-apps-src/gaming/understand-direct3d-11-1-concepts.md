...
La ressource sous-jacente doit être créée avec des propriétés compatibles avec les types d’affichages qui seront créés à partir de cette ressource. Par exemple, si un [ **ID3D11RenderTargetView** ](https://msdn.microsoft.com/library/windows/desktop/ff476582) est appliqué à une surface, surface est créée avec le [ **D3D11\_lier\_rendu\_ CIBLE** ](https://msdn.microsoft.com/library/windows/desktop/ff476085) indicateur. La surface doit aussi avoir un format de surface d’exposition de DXGI compatible avec le rendu (consultez [ **DXGI\_FORMAT**](https://msdn.microsoft.com/library/windows/desktop/bb173059)).
