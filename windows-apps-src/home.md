---
Description: Voici les informations dont vous avez besoin pour créer une application Windows universelle pouvant s’exécuter sur tout appareil basé sur Windows 10, notamment les téléphones, tablettes ou PC.
title: Guides de procédure pour les applications Windows 10 - Développement d’applications Windows
ms.assetid: 2A39F3D8-85AD-4315-A69B-2B79242780E3
URL de redirection : https://msdn.microsoft.com/windows/uwp/index
---
...
Voici les informations dont vous avez besoin pour créer une application Windows universelle pouvant s’exécuter sur tout appareil basé sur Windows 10, notamment les téléphones, tablettes ou PC. Cette section fournit des instructions et des exemples de code organisés par le type de tâche à accomplir.
...
| [Entreprise](enterprise/index.md) | En savoir plus sur les fonctionnalités principales d’entreprise des applications de la plateforme Windows universelle (UWP) Windows 10. |
