...
<ul class="cols cols3">
    <li>
        ...
        <h3>Création d’applications de C++ Win32 ARM64</h3><p>Découvrez comment installer les outils de ARM64 pour Visual Studio. Puis nous allons vous guidons à travers les étapes de création et de compilation d’un nouveau projet de 64 ARM.</p>
    </li>
    <li>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <a class="card" href="/windows/uwp/porting/apps-on-arm" title="Commencer" data-linktype="absolute-path">
